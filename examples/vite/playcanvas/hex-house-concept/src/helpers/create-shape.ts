...
export const createShape = async (
    ...
    if (scene && bitbybit) {
        ...
        current.groups.forEach((group) => {
            ...
            if (group.children && group.children[1]) {
                const edgeEntity = group.children[1] as Entity;
