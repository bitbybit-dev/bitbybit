...
import { Color3, PBRMetallicRoughnessMaterial, Scene } from "@babylonjs/core";
...
export const createShape = async (
  ...
  if (scene && bitbybit) {
    ...
    const mat1 = new PBRMetallicRoughnessMaterial("mat1");
    mat1.baseColor = Color3.FromHexString(model.color);
    mat1.zOffset = 2;
    ...
    const mat2 = new PBRMetallicRoughnessMaterial("mat2");
    mat2.baseColor = Color3.FromHexString("#010101");
    mat2.zOffset = 2;
    ...
    const mat3 = new PBRMetallicRoughnessMaterial("mat3");
    mat3.baseColor = Color3.FromHexString("#333333");
    mat3.zOffset = 2;
