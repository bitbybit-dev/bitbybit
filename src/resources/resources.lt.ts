...
export const resourcesLt: ResourcesInterface = {
    ...
    block_integer: 'Sveikas skaicius',
    ...
    block_verb_core_vector_sub_input_first: 'Atimti vektoriu',
    block_verb_core_vector_sub_input_second: 'Is vektoriaus',
    ...
    block_verb_core_vector_distance_input_first: 'Atstumas tarp tasko',
    block_verb_core_vector_distance_input_second: 'Ir tasko',
    block_verb_core_vector_distance_description: 'Matuoja atstuma tarp dvieju tasku.',
    block_verb_core_vector_distance_squared_input_first: 'Kvadratinis atstumas tarp tasko',
    block_verb_core_vector_distance_squared_input_second: 'Ir tasko',
    block_verb_core_vector_distance_squared_description: 'Matuoja kvadratini Euklido atstuma tarp dvieju tasku.',
    ...
    block_verb_core_vector_lerp_fraction: 'Taskas frakcijoje',
    block_verb_core_vector_lerp_input_first: 'Tarp vektoriaus',
    block_verb_core_vector_lerp_input_second: 'Ir vektoriaus',
    block_verb_core_vector_lerp_description: 'Grazina taska tarp dvieju vektoriu davus frakcini parametra.',
    block_verb_core_vector_max_input_vector: 'Didziausias skaicius vektoriuje',
    block_verb_core_vector_max_description: 'Grazina didziausia skaiciu vektoriuje.',
    block_verb_core_vector_min_input_vector: 'Maziausias skaicius vektoriuje',
    block_verb_core_vector_min_description: 'Grazina maziausia skaiciu vektoriuje.',
    block_verb_core_vector_mul_input_vector: 'Dauginti vektoriu',
    block_verb_core_vector_mul_input_scalar: 'Is skaiciaus',
    block_verb_core_vector_mul_description: 'Dauginti vektoriu is skaiciaus.',
    block_verb_core_vector_negate_input_vector: 'Negatyvus vektorius',
    block_verb_core_vector_negate_description: 'Grazina negatyvu vektoriu.',
    block_verb_core_vector_norm_input_vector: 'Vektoriaus norma',
    block_verb_core_vector_norm_description: 'Grazina vektoriaus ilgi nuo 0.',
    block_verb_core_vector_norm_squared_input_vector: 'Vektoriaus normos kvadratas',
    block_verb_core_vector_norm_squared_description: 'Grazina normos kvadarata vektoriui',
    block_verb_core_vector_normalized_input_vector: 'Normalizuotas vektorius',
    block_verb_core_vector_normalized_description: 'Grazina normalizuota vektoriu kurio ilgis lygus 1, o kryptis nekinta.',
    block_verb_core_vector_on_ray_input_vector: 'Kryptimi vektoriaus',
    block_verb_core_vector_on_ray_input_point: 'Perkelti taska',
    block_verb_core_vector_on_ray_input_distance: 'Atstumu',
    block_verb_core_vector_on_ray_description: 'Perkelia taska duotu atstumu i kita vieta vektoriaus kryptimi.',
    ...
    block_verb_core_vector_positive_angle_between_description: 'Grazina teigiama kampa tarp dvieju vektoriu naudojant etalonine krypti.',
    block_verb_core_vector_signed_angle_between_input_first: 'Zenklintas kampas tarp vektoriaus',
    ...
    block_verb_core_vector_signed_angle_between_description: 'Grazina zenklinta +/- kampa tarp dvieju vektoriu naudojant etalonine krypti.',
    block_verb_core_vector_range_input_max: 'Diapozonas iki maksimalios ribos',
    block_verb_core_vector_range_description: 'Sukuria skaiciu rinkini nuo 0 iki maksimalios ribos.',
    block_verb_core_vector_span_input_min: 'Skaiciu diapozonas tarp minimumo',
    ...
    block_verb_geometry_nurbs_curve_clone_input_curve: 'Klonuoti kreive',
    block_verb_geometry_nurbs_curve_clone_description: 'Klonuoja kreive.',
    block_verb_geometry_nurbs_curve_closest_param_input_curve: 'Arciausias parametras ant kreives',
    block_verb_geometry_nurbs_curve_closest_param_input_point: 'Nuo tasko',
    block_verb_geometry_nurbs_curve_closest_param_description: 'Randa arciausia kreives parametra nuo duoto tasko.',
    block_verb_geometry_nurbs_curve_closest_params_input_curve: 'Arciausi parametrai ant kreives',
    block_verb_geometry_nurbs_curve_closest_params_input_points: 'Nuo tasku',
    block_verb_geometry_nurbs_curve_closest_params_description: 'Randa arciausius kreives parametrus nuo duotu tasku kolekcijos.',
    block_verb_geometry_nurbs_curve_closest_point_input_curve: 'Arciausias taskas ant kreives',
    block_verb_geometry_nurbs_curve_closest_point_input_point: 'Nuo tasko',
    ...
    block_verb_geometry_nurbs_surface_by_corners_input_point1: 'Pavirsius su pirmo kampo tasku',
    block_verb_geometry_nurbs_surface_by_corners_input_point2: 'Antro kampo tasku',
    block_verb_geometry_nurbs_surface_by_corners_input_point3: 'Trecio kampo tasku',
    block_verb_geometry_nurbs_surface_by_corners_input_point4: 'Ketvirto kampo tasku',
    block_verb_geometry_nurbs_surface_by_corners_description: 'Sukuria pavirsiu is keturiu kampu.',
    block_verb_geometry_nurbs_surface_by_knots_control_points_weights_input_knots_u: 'Pavirsius su u saitais',
    block_verb_geometry_nurbs_surface_by_knots_control_points_weights_input_knots_v: 'V saitais',
    block_verb_geometry_nurbs_surface_by_knots_control_points_weights_input_points: 'Kontroliniais taskais',
    ...
    block_verb_geometry_nurbs_surface_clone_input_surface: 'Klonuoti pavirsiu',
    block_verb_geometry_nurbs_surface_clone_description: 'Klonuoja pavirsiu.',
    block_verb_geometry_nurbs_surface_closest_param_input_surface: 'Arciausias uv parametras ant pavirsiaus',
    block_verb_geometry_nurbs_surface_closest_param_input_point: 'Nuo tasko',
    block_verb_geometry_nurbs_surface_closest_param_description: 'Randa arciausia uv parametra ant pavirsiaus nuo duoto tasko.',
    block_verb_geometry_nurbs_surface_closest_point_input_surface: 'Arciausias taskas ant pavirsiaus',
    block_verb_geometry_nurbs_surface_closest_point_input_point: 'Nuo tasko',
    block_verb_geometry_nurbs_surface_closest_point_description: 'Randa arciausia taska ant pavirsiaus nuo duoto tasko.',
    block_verb_geometry_nurbs_surface_control_points_input_surface: 'Kontroliniai pavirsiaus taskai',
    block_verb_geometry_nurbs_surface_control_points_description: 'Grazina kontrolinius pavirsiaus taskus.',
    block_verb_geometry_nurbs_surface_degree_u_input_surface: 'Pavirsiaus u laipsnis',
    block_verb_geometry_nurbs_surface_degree_u_points_description: 'Grazina pavirsiaus u laipsni.',
    block_verb_geometry_nurbs_surface_degree_v_input_surface: 'Pavirsiaus v laipsnis',
    block_verb_geometry_nurbs_surface_degree_v_points_description: 'Grazina pavirsiaus v laipsni.',
    block_verb_geometry_nurbs_surface_derivatives_input_surface: 'Pavirsiaus isvestines',
    ...
    block_verb_geometry_nurbs_surface_derivatives_input_num_derivatives: 'Isvestiniu skaicius',
    block_verb_geometry_nurbs_surface_derivatives_description: 'Grazina pavirsiaus isvestines ant uv koordinates parametro.',    
    block_verb_geometry_nurbs_surface_domain_u_input_surface: 'U pavirsiaus domenas',
    block_verb_geometry_nurbs_surface_domain_u_description: 'Grazina u pavirsiaus domena intervalo pavidalu.',
    block_verb_geometry_nurbs_surface_domain_v_input_surface: 'V pavirsiaus domenas',
    block_verb_geometry_nurbs_surface_domain_v_description: 'Grazina v pavirsiaus domena intervalo pavidalu.',
    block_verb_geometry_nurbs_surface_isocurve_input_surface: 'Izokreive ant pavirsiaus',
    block_verb_geometry_nurbs_surface_isocurve_input_parameter: 'Ties parametru',
    block_verb_geometry_nurbs_surface_isocurve_input_use_v: 'Naudojant v krypti',
    block_verb_geometry_nurbs_surface_isocurve_description: 'Gauna izokreive ant pavirsiaus parametro u arba v kryptimi.',
    block_verb_geometry_nurbs_surface_knots_u_input_surface: 'Saitai u kryptimi ant pavirsiaus',
    block_verb_geometry_nurbs_surface_knots_u_description: 'Gauna u saitus ant pavirsiaus.',
    block_verb_geometry_nurbs_surface_knots_v_input_surface: 'Saitai v kryptimi ant pavirsiaus',
    block_verb_geometry_nurbs_surface_knots_v_description: 'Gauna v saitus ant pavirsiaus.',
    block_verb_geometry_nurbs_surface_normal_input_surface: 'Pavirsiaus statmuo',
    block_verb_geometry_nurbs_surface_normal_input_u: 'Ant u koordinates',
    block_verb_geometry_nurbs_surface_normal_input_v: 'Ir v koordinates',
    block_verb_geometry_nurbs_surface_normal_description: 'Gauna pavirsiaus statmeni ant uv koordinaciu.',
    block_verb_geometry_nurbs_surface_point_input_surface: 'Pavirsiaus taskas',
    block_verb_geometry_nurbs_surface_point_input_u: 'Ant u koordinates',
    block_verb_geometry_nurbs_surface_point_input_v: 'Ir v koordinates',
    block_verb_geometry_nurbs_surface_point_description: 'Gauna pavirsiaus taska ant uv koordinaciu.',
    block_verb_geometry_nurbs_surface_reverse_input_surface: 'Apgrezti pavirsiu',
    block_verb_geometry_nurbs_surface_reverse_description: 'Apgrezia pavirsiaus uv kryptis.',
    block_verb_geometry_nurbs_surface_split_input_surface: 'Padalinti pavirsiu',
    block_verb_geometry_nurbs_surface_split_input_parameter: 'Ties parametru',
    block_verb_geometry_nurbs_surface_split_input_use_v: 'Naudojant v krypti',
    block_verb_geometry_nurbs_surface_split_description: 'Padalina pavirsiu i dvi dalis ties parametru.',
    block_verb_geometry_nurbs_surface_weights_input_surface: 'Pavirsiaus svoriai',
    block_verb_geometry_nurbs_surface_weights_description: 'Grazina pavirsiaus svorius.',
};
