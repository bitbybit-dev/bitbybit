...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    block_base_promises_catch_input_promise_one: 'When the',
    block_base_promises_catch_var_error: 'error',
    block_base_promises_catch_input_promise_two: 'happens in the promise',
    block_base_promises_catch_statement_catch: 'Catch',
    block_base_promises_catch_description: 'Catches the error that may happen while running asynchronous code. User can choose to handle errors appropriately.',
    block_base_promises_then_input_promise_one: 'When the',
    block_base_promises_then_var_result: 'result',
    block_base_promises_then_input_promise_two: 'of promise is returned',
    block_base_promises_then_statement_catch: 'Then',
    block_base_promises_then_description: 'When asynchronous code finishes execution, this component can be used to continue further steps that are dependant on it.',
