...
export const resourcesEn: ResourcesInterface = {
    ...
    block_babylon_draw_lines_description: 'Draws a coloured line in space of selected width',
    block_babylon_draw_point_description: 'Draws a coloured point in space of selected size',
};
