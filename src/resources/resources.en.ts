...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    verb_geometry_intersect_curve_curve_first_params_input_intersections: 'Params on first curve intersection',
    verb_geometry_intersect_curve_curve_first_params_description: 'Returns parameters on first curve from the two curve intersections.',
    verb_geometry_intersect_curve_curve_second_params_input_intersections: 'Params on second curve intersection',
    verb_geometry_intersect_curve_curve_second_params_description: 'Returns parameters on second curve from the two curve intersections.',
    verb_geometry_intersect_curve_curve_first_points_input_intersections: 'Points on first curve intersection',
    verb_geometry_intersect_curve_curve_first_points_description: 'Returns points on first curve from the two curve intersections.',
    verb_geometry_intersect_curve_curve_second_points_input_intersections: 'Points on second curve intersection',
    verb_geometry_intersect_curve_curve_second_points_description: 'Returns points on second curve from the two curve intersections.',
