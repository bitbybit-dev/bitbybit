...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    block_base_text_print_save_input_text: 'Preview text and save to file',
    block_base_text_print_save_description: 'Print and save the text to a file of chosen extension. This allows you to export various kinds of prepared information to formats like csv, gcode or others.',
    block_base_text_save_input_text: 'Save text to file',
    block_base_text_save_description: 'Saves text to a file and allows you to choose the name and extension. This component does not preview the text and can be used in situations where text may be too big to edit in text area field.',
});
