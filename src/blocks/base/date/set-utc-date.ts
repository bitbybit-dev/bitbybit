...
export function createDateSetUtcDateBlock() {

    const resources = ResourcesService.getResources();
    const blockSelector = 'base_date_set_utc_date';
    ...
    Blocks[blockSelector] = {
        init() {
            this.appendValueInput('Date')
                ...
                .appendField(resources.block_base_date_set_utc_date_input_date);
            this.appendValueInput('Day')
                .setCheck('Number')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_base_date_set_utc_date_input_day.toLowerCase());
