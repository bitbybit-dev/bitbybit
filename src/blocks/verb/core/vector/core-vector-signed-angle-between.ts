...
export function createCoreVectorSignedAngleBetweenBlock() {
    ...
    const blockSelector = 'verb_core_vector_signed_angle_between';
    ...
    Blocks[blockSelector] = {
        init() {
            this.appendValueInput('First')
                ...
                .appendField(resources.block_verb_core_vector_signed_angle_between_input_first);
            this.appendValueInput('Second')
                .setCheck('Array')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_verb_core_vector_signed_angle_between_input_second.toLowerCase());
            this.appendValueInput('Reference')
                .setCheck('Array')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_verb_core_vector_signed_angle_between_input_reference.toLowerCase());
    ...
    JavaScript[blockSelector] = (block: Block) => {
        const inputs = {
            ...
            reference: JavaScript.valueToCode(block, 'Reference', JavaScript.ORDER_ATOMIC),
        };
        ...
        const code = createStandardContextIIFE(block, blockSelector, inputs, true,
            `return verb.core.Vec.signedAngleBetween(inputs.first, inputs.second, inputs.reference);`);
