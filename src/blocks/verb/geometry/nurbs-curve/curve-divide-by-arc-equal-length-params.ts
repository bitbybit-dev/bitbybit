...
export function createCurveDivideByEqualArcLengthParamsBlock() {
    ...
    Blocks['verb_geometry_nurbs_curve_divide_by_equal_arc_length_params'] = {
        init: function () {
    ...
    JavaScript['verb_geometry_nurbs_curve_divide_by_equal_arc_length_params'] = function (block) {
