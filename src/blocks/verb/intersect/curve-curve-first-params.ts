    ...
    Blocks[blockSelector] = {
        init() {
            this.appendValueInput('Intersections')
                ...
                .appendField(resources.verb_geometry_intersect_curve_curve_first_params_input_intersections);
            this.setOutput(true, 'Number');
            this.setColour('#fff');
            this.setTooltip(resources.verb_geometry_intersect_curve_curve_first_params_description);
            this.setHelpUrl('');
        }
    };
