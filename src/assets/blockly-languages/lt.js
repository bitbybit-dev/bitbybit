export function activateLanguage() {
    ...
    Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] = "Suskleisti blokai turi įspėjimų.";
    ...
    Blockly.Msg["CONTROLS_FOREACH_TITLE"] = "kartok su kiekvienu %1 iš rinkinio %2";
    Blockly.Msg["CONTROLS_FOREACH_TOOLTIP"] = "Kartok veiksmus, kol kintamasis \"%1\" paeiliui gauna kiekvieną rinkinio reikšmę.";
    ...
    Blockly.Msg["LISTS_CREATE_EMPTY_TITLE"] = "tuščias rinkinys";
    Blockly.Msg["LISTS_CREATE_EMPTY_TOOLTIP"] = "Grąžina rinkinį, ilgio 0, neturintį duomenų";
    Blockly.Msg["LISTS_CREATE_WITH_CONTAINER_TITLE_ADD"] = "rinkinys";
    ...
    Blockly.Msg["LISTS_CREATE_WITH_INPUT_WITH"] = "sukurti rinkinį su";
    Blockly.Msg["LISTS_CREATE_WITH_ITEM_TOOLTIP"] = "Pridėti elementą į rinkinį.";
    Blockly.Msg["LISTS_CREATE_WITH_TOOLTIP"] = "Sukurti rinkinį iš bet kokio skaičiaus elementų.";
    ...
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_FIRST"] = "Grąžina pirmąjį rinkinio elementą.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_FROM"] = "Grąžina objektą į nurodyta poziciją rinkinyje.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_LAST"] = "Grąžina paskutinį elementą iš rinkinio.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_RANDOM"] = "Grąžina atsitiktinį elementą iš rinkinį.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST"] = "Pašalina ir grąžina pirmą elementą rinkinyje.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM"] = "Pašalina ir grąžina elementą nurodytoje rinkinio pozicijoje.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST"] = "Pašalina ir grąžina paskutinį elementą rinkinyje.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM"] = "Pašalina ir grąžina atsitiktinį elementą rinkinyje.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST"] = "Pašalina pirmą objektą rinkinyje.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM"] = "Pašalina objektą iš nurodytos vietos rinkinyje.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST"] = "Pašalina paskutinį objektą rinkinyje.";
    Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM"] = "Pašalina atsitiktinį objektą rinkinyje.";
    ...
    Blockly.Msg["LISTS_GET_SUBLIST_START_FIRST"] = "rinkinio dalis nuo pradžios";
    Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_END"] = "rinkinio dalis nuo # nuo galo";
    Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_START"] = "rinkinio dalis nuo #";
    Blockly.Msg["LISTS_GET_SUBLIST_TAIL"] = "";  // untranslated
    Blockly.Msg["LISTS_GET_SUBLIST_TOOLTIP"] = "Sukuria nurodytos rinkinio dalies kopiją.";
    ...
    Blockly.Msg["LISTS_INDEX_OF_TOOLTIP"] = "Grąžina pirmos/paskutinės reikšmės eilės nr. rinkinyje. Grąžina %1, jei reikšmės neranda.";
    Blockly.Msg["LISTS_INLIST"] = "rinkinyje";
    Blockly.Msg["LISTS_ISEMPTY_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#is-empty";  // untranslated
    Blockly.Msg["LISTS_ISEMPTY_TITLE"] = "%1 yra tuščias";
    Blockly.Msg["LISTS_ISEMPTY_TOOLTIP"] = "Grąžina „true“, jeigu rinkinys tuščias.";
    Blockly.Msg["LISTS_LENGTH_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#length-of";  // untranslated
    Blockly.Msg["LISTS_LENGTH_TITLE"] = "ilgis %1";
    Blockly.Msg["LISTS_LENGTH_TOOLTIP"] = "Grąžina rinkinio ilgį.";
    Blockly.Msg["LISTS_REPEAT_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#create-list-with";  // untranslated
    Blockly.Msg["LISTS_REPEAT_TITLE"] = "sukurk rinkinį, kuriame %1 bus %2 kartus";
    Blockly.Msg["LISTS_REPEAT_TOOLTIP"] = "Sukuria rinkinį turintį elementą kuris kartojasi nurodytą kartų skaičių.";
    Blockly.Msg["LISTS_REVERSE_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#reversing-a-list";  // untranslated
    Blockly.Msg["LISTS_REVERSE_MESSAGE0"] = "Apgręžti %1";
    Blockly.Msg["LISTS_REVERSE_TOOLTIP"] = "Apgręžti rinkinį.";
    ...
    Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST"] = "Įterpia objektą į rinkinio pradžią.";
    Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_FROM"] = "Įterpią objektą į nurodytą vietą rinkinyje.";
    Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_LAST"] = "Pridėti elementą į rinkinio galą.";
    Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM"] = "Įterpia objektą į atsitiktinę rinkinio vietą.";
    Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_FIRST"] = "Priskiria pirmą elementą rinkiniui.";
    Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_FROM"] = "Priskiria elementą nurodytoje rinkinio pozicijoje.";
    Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_LAST"] = "Priskiria paskutinį elementą rinkiniui.";  // untranslated
    Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_RANDOM"] = "Priskiria elementą rinkiniui atisitiktinėje vietoje.";  // untranslated
    ...
    Blockly.Msg["LISTS_SORT_TOOLTIP"] = "Rūšiuoti rinkinio kopiją.";
    ...
    Blockly.Msg["LISTS_SPLIT_LIST_FROM_TEXT"] = "sukurti rinkinį iš teksto";
    Blockly.Msg["LISTS_SPLIT_TEXT_FROM_LIST"] = "sukurti tekstą iš rinkinio";
    ...
    Blockly.Msg["MATH_CHANGE_TITLE"] = "padidink %1 verte %2";
    ...
    Blockly.Msg["MATH_ONLIST_OPERATOR_MAX"] = "didžiausia reikšmė rinkinyje";
    Blockly.Msg["MATH_ONLIST_OPERATOR_MEDIAN"] = "mediana rinkiniui";
    Blockly.Msg["MATH_ONLIST_OPERATOR_MIN"] = "mažiausia reikšmė rinkinyje";
    Blockly.Msg["MATH_ONLIST_OPERATOR_MODE"] = "statistinė moda rinkiniui";
    Blockly.Msg["MATH_ONLIST_OPERATOR_RANDOM"] = "atsitiktinis elementas iš rinkinio";
    Blockly.Msg["MATH_ONLIST_OPERATOR_STD_DEV"] = "standartinis nuokrypis rinkinyje";
    Blockly.Msg["MATH_ONLIST_OPERATOR_SUM"] = "suma";
    Blockly.Msg["MATH_ONLIST_TOOLTIP_AVERAGE"] = "Grįžti vidurkiu (aritmetinis vidurkis) iš skaitinių reikšmių rinkinyje.";
    Blockly.Msg["MATH_ONLIST_TOOLTIP_MAX"] = "Grįžti didžiausiu skaičiumi rinkinyje.";
    Blockly.Msg["MATH_ONLIST_TOOLTIP_MEDIAN"] = "Grąžinti rinkinio medianą.";
    Blockly.Msg["MATH_ONLIST_TOOLTIP_MIN"] = "Grįžti mažiausiu skaičiumi rinkinyje.";
    Blockly.Msg["MATH_ONLIST_TOOLTIP_MODE"] = "Grąžinti rinkinį dažniausių elementų rinkinyje.";
    Blockly.Msg["MATH_ONLIST_TOOLTIP_RANDOM"] = "Grąžinti atsitiktinį elementą iš rinkinio.";
    Blockly.Msg["MATH_ONLIST_TOOLTIP_STD_DEV"] = "Grįžti standartine pakraipa iš rinkinio.";
    ...
    Blockly.Msg["TEXT_CHARAT_TITLE"] = "tekste %1 %2";  // untranslated
