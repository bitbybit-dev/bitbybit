...
export class JSCADPolygon {
     ...
     * @drawable true
     */
    async createFromPoints(inputs: Inputs.JSCAD.PointsDto): Promise<Inputs.JSCAD.JSCADEntity> {
     ...
     * @drawable true
     */
    async createFromPolyline(inputs: Inputs.JSCAD.PolylineDto): Promise<Inputs.JSCAD.JSCADEntity> {
     ...
     * @drawable true
     */
    async createFromCurve(inputs: Inputs.JSCAD.CurveDto): Promise<Inputs.JSCAD.JSCADEntity> {
