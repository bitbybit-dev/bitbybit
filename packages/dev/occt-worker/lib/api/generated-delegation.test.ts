...
const DELEGATIONS: [string, (occt: OCCT) => unknown][] = [
    ...
    ["assembly.manager.setDocLabelColor", (o) => o.assembly.manager.setDocLabelColor(asInputs())],
    ["assembly.manager.setDocLabelName", (o) => o.assembly.manager.setDocLabelName(asInputs())],
