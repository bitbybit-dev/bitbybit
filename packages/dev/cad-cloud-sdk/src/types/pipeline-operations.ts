...
// Generated from operation-catalog.json v1.1.1
// ---------------------------------------------------------------------------
...
export interface OperationParams {
    ...
    "occt.assembly.manager.combineStructure": {
        ...
        /** Parts imported from other documents (e.g. STEP-loaded). Each entry references a source document via `sourceDocumentIndex` (matching the order of `sourceDocuments` on buildAssemblyDocument) and copies a label (or all free shapes) into this assembly, preserving sub-assembly hierarchy, names and colors. Instance nodes can then reference them by `partId` to place the imported assembly multiple times with different transforms. */
