...
const DELEGATIONS: [string, (manifold: ManifoldBitByBit) => unknown][] = [
    ...
    ["manifold.booleans.minkowskiDifference", (m) => m.manifold.booleans.minkowskiDifference(asInputs())],
    ["manifold.booleans.minkowskiSum", (m) => m.manifold.booleans.minkowskiSum(asInputs())],
    ...
    ["manifold.evaluate.rayCast", (m) => m.manifold.evaluate.rayCast(asInputs())],
    ...
    ["mesh.evaluate.backside", (m) => m.mesh.evaluate.backside(asInputs())],
    ["mesh.evaluate.extras", (m) => m.mesh.evaluate.extras(asInputs())],
    ["mesh.evaluate.hasNormals", (m) => m.mesh.evaluate.hasNormals(asInputs())],
