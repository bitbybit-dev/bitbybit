## API Report File for "@bitbybit-dev/playcanvas"
...
export class Draw extends DrawCore {
    ...
    drawAny<E extends Inputs_2.Draw.Entity>(inputs: Inputs_2.Draw.DrawAny<pc_2.Entity, E>): Inputs_2.Draw.Drawn<E, Inputs_2.Draw.BitByBitEntity>;
    // Warning: (ae-forgotten-export) The symbol "Inputs_2" needs to be exported by the entry point index.d.ts
    drawAnyAsync<E extends Inputs_2.Draw.Entity>(inputs: Inputs_2.Draw.DrawAny<pc_2.Entity, E>): Promise<Inputs_2.Draw.Drawn<E, Inputs_2.Draw.BitByBitEntity>>;
    // (undocumented)
...
namespace Draw_2 {
    ...
    interface BitByBitEntity extends pc_2.Entity {
        // (undocumented)
    ...
    interface PolylineEntity extends pc_2.Entity {
        // (undocumented)
...
export class DrawHelper extends DrawHelperCore {
    ...
    }[], group: pc_2.Entity | undefined, updatable: boolean, material: pc_2.StandardMaterial, addToScene: boolean, hidden: boolean): pc_2.Entity;
    dispose(): void;
    // (undocumented)
    drawCurve(inputs: Inputs_2.Verb.DrawCurveDto<pc_2.Entity>): pc_2.Entity;
    // (undocumented)
    ...
    // (undocumented)
    drawManifoldsOrCrossSections(inputs: Inputs_2.Manifold.DrawManifoldsOrCrossSectionsDto<Inputs_2.Manifold.ManifoldPointer | Inputs_2.Manifold.CrossSectionPointer, pc_2.StandardMaterial>): Promise<pc_2.Entity>;
    // (undocumented)
    drawPoint(inputs: Inputs_2.Point.DrawPointDto<pc_2.Entity>): pc_2.Entity;
    // (undocumented)
    drawPoints(inputs: Inputs_2.Point.DrawPointsDto<pc_2.Entity> & {
        colorMapStrategy?: Inputs_2.Base.colorMapStrategyEnum;
    }): pc_2.Entity;
    // (undocumented)
    drawPolyline(mesh: pc_2.Entity | undefined, pointsToDraw: Inputs_2.Base.Point3[], updatable: boolean, size: number, opacity: number, colours: string | string[], arrowSize?: number, arrowAngle?: number): pc_2.Entity;
    // (undocumented)
    drawPolylineClose(inputs: Inputs_2.Polyline.DrawPolylineDto<pc_2.Entity> & {
        arrowSize?: number;
        arrowAngle?: number;
    }): pc_2.Entity;
    drawPolylinesWithColours(inputs: Inputs_2.Polyline.DrawPolylinesDto<pc_2.Entity> & {
        colorMapStrategy?: Inputs_2.Base.colorMapStrategyEnum;
        arrowSize?: number;
        arrowAngle?: number;
    }): pc_2.Entity;
    // (undocumented)
    drawShape(inputs: Inputs_2.OCCT.DrawShapeDto<Inputs_2.OCCT.TopoDSShapePointer>): Promise<pc_2.Entity>;
    // (undocumented)
    drawShapes(inputs: Inputs_2.OCCT.DrawShapesDto<Inputs_2.OCCT.TopoDSShapePointer>): Promise<pc_2.Entity>;
    // (undocumented)
    drawSolidOrPolygonMesh(inputs: Inputs_2.JSCAD.DrawSolidMeshDto<pc_2.Entity>): Promise<pc_2.Entity>;
    // (undocumented)
    drawSolidOrPolygonMeshes(inputs: Inputs_2.JSCAD.DrawSolidMeshesDto<pc_2.Entity>): Promise<pc_2.Entity>;
    // (undocumented)
    drawSurface(inputs: Inputs_2.Verb.DrawSurfaceDto<pc_2.Entity>): pc_2.Entity;
    // (undocumented)
    drawSurfacesMultiColour(inputs: Inputs_2.Verb.DrawSurfacesColoursDto<pc_2.Entity> & {
        colorMapStrategy?: Inputs_2.Base.colorMapStrategyEnum;
    }): pc_2.Entity;
    // (undocumented)
    handleDecomposedMesh(inputs: Omit<Inputs_2.OCCT.DrawShapeDto<Inputs_2.OCCT.TopoDSShapePointer>, "shape">, decomposedMesh: Inputs_2.OCCT.DecomposedMeshDto, options: Partial<Inputs_2.Draw.DrawOcctShapeOptions>): Promise<pc_2.Entity>;
    // (undocumented)
    handleDecomposedMeshIndividually(inputs: Omit<Inputs_2.OCCT.DrawShapeDto<Inputs_2.OCCT.TopoDSShapePointer>, "shape">, decomposedMesh: Inputs_2.OCCT.DecomposedMeshDto, options: Partial<Inputs_2.Draw.DrawOcctShapeOptions>): Promise<pc_2.Entity>;
    isDisposed(): boolean;
    // (undocumented)
    updatePointsInstances(group: pc_2.Entity, positions: Inputs_2.Base.Point3[]): void;
    // (undocumented)
    readonly vector: Vector_2;
}

// @public
export function initBitByBit(app: pc_2.AppBase, scene: pc_2.Entity, bitbybit: BitByBitBase, options: InitBitByBitOptions): Promise<InitKernelsResult & {
...
interface InitPlayCanvasResult {
    app: pc_2.Application;
    directionalLight: pc_2.Entity;
    dispose: () => void;
    ground: pc_2.Entity | null;
...
declare namespace Inputs {
    export {
        ...
        Transforms,
        Vector,
        PlayCanvasCamera_2 as PlayCanvasCamera,
        PlayCanvasOrbitCameraInstance,
        PlayCanvasInputHandler,
        PlayCanvasOrbitCameraController,
        InitPlayCanvasResult,
        PlayCanvasScene,
        Draw_2 as Draw,
        Base_3 as Base
    }
...
// @public
namespace PlayCanvasCamera_2 {
    // (undocumented)
    class CameraDto {
        constructor(camera?: pc_2.Entity);
        camera: pc_2.Entity;
    }
    // (undocumented)
    class FocusEntityDto {
        constructor(orbitCamera?: any, entity?: pc_2.Entity);
        entity: pc_2.Entity;
        orbitCamera: any;
    }
    // (undocumented)
    class OrbitCameraDto {
        ...
        focusEntity?: pc_2.Entity | undefined;
    ...
    // (undocumented)
    class PivotPointDto {
        constructor(orbitCamera?: any, pivotPoint?: Base_3.Point3);
        orbitCamera: any;
        pivotPoint: Base_3.Point3;
    }
    // (undocumented)
    class PositionDto {
        constructor(camera?: pc_2.Entity, position?: Base_3.Point3);
        camera: pc_2.Entity;
...
export class PlayCanvasOrbitCamera {
    constructor(context: Context);
    // Warning: (ae-forgotten-export) The symbol "OrbitCameraController" needs to be exported by the entry point index.d.ts
    create(inputs: Inputs_2.PlayCanvasCamera.OrbitCameraDto): OrbitCameraController;
    focusOnEntity(inputs: Inputs_2.PlayCanvasCamera.FocusEntityDto): void;
    getPivotPoint(inputs: Inputs_2.PlayCanvasCamera.PivotPointDto): Inputs_2.Base.Point3;
    resetCamera(inputs: Inputs_2.PlayCanvasCamera.ResetCameraDto): void;
    setPivotPoint(inputs: Inputs_2.PlayCanvasCamera.PivotPointDto): void;
}

// @public
interface PlayCanvasOrbitCameraController {
    // (undocumented)
    cameraEntity: pc_2.Entity;
    // (undocumented)
    destroy: () => void;
    // (undocumented)
...
interface PlayCanvasOrbitCameraInstance {
    ...
    distanceMin: number;
    // (undocumented)
    focus(focusEntity: pc_2.Entity): void;
    // (undocumented)
    focusEntity: pc_2.Entity | null;
    // (undocumented)
    frameOnStart: boolean;
    // (undocumented)
    inertiaFactor: number;
    ...
    pitchAngleMin: number;
    // (undocumented)
    pivotPoint: pc_2.Vec3;
    // (undocumented)
    reset(yaw: number, pitch: number, distance: number): void;
    // (undocumented)
    resetAndLookAtEntity(resetPoint: pc_2.Vec3, entity: pc_2.Entity): void;
    // (undocumented)
    resetAndLookAtPoint(resetPoint: pc_2.Vec3, lookAtPoint: pc_2.Vec3): void;
    // (undocumented)
    update(dt: number): void;
    // (undocumented)
    yaw: number;
...
// @public
namespace PlayCanvasScene {
    // (undocumented)
    class InitPlayCanvasDto {
        constructor(canvasId?: string, sceneSize?: number, backgroundColor?: string, enableShadows?: boolean, enableGround?: boolean, groundCenter?: Base_3.Point3, groundScaleFactor?: number, groundColor?: string, groundOpacity?: number, ambientLightColor?: string, ambientLightIntensity?: number, directionalLightColor?: string, directionalLightIntensity?: number, shadowMapSize?: number);
        ...
        orbitCameraOptions?: PlayCanvasCamera_2.OrbitCameraDto | undefined;
        sceneSize: number;
