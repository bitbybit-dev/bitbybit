...
import { dimensionEndTypeEnum, directionEnum } from "./02-enums";
import { LPolygonDto } from "./06-profiles-and-primitive-solids";
import { ChristmasTreeDto, Heart2DDto, NGonWireDto, ParallelogramDto, StarDto } from "./16-faces-2d-curves-and-decorative-wires";
