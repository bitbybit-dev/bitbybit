import createBitbybitDevOcctOriginal from "./bitbybit-dev-occt-64-bit.js";
...
const createBitbybitDevOcct = (moduleOverrides = {}) => {
    const cdnWasmUrl = GlobalCDNProvider.BITBYBIT_CDN_URL + "/wasm/bitbybit-dev-occt-64-bit.58990ca9.wasm";
