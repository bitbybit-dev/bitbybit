...
export class BabylonScene {
    ...
    enableSkybox(inputs: Inputs.BabylonScene.SkyboxDto): void {
        ...
        if (inputs.skybox === Inputs.Base.skyboxEnum.default) {
            ...
            texture = BABYLON.CubeTexture.CreateFromPrefilteredData("https://cdn.jsdelivr.net/gh/bitbybit-dev/bitbybit-assets@0.16.4/textures/skybox/city/environmentSpecular.env",
                this.context.scene, false, false);
        }
