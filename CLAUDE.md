...
TypeScript does not merge a namespace across modules and the API declarations the visual editors
are generated from read it as one - is generated by `scripts/gen-occ-inputs.mjs` from the fragments in
