...
<ImageGallery
  images={['/img/cad-cloud/bitbybit-cad-cloud-batch-model-generation.webp']}
  columns={1}
  altPrefix="Bitbybit Studio model generator interface"
/>
...
<ImageGallery
  ...
  columns={2}
  altPrefix="CAD visual playground operators and pipeline execution"
/>
...
<ImageGallery
  ...
  columns={2}
  altPrefix="CAD Cloud task processing status tracking"
/>
...
<ImageGallery
  images={[
    ...
    '/img/cad-cloud/bitbybit-cad-cloud-viewer-batch-compute-result.webp'
  ]}
  columns={2}
  altPrefix="Interactive 3D preview of generated parametric models in CAD Cloud"
/>
