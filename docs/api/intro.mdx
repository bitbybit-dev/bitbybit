...
| Resource | Link |
|----------|------|
| **API reference** | [API Reference](/api/openapi-docs/bitbybit-cad-cloud-api) |
...
| **OpenAPI specification** | [openapi.json](https://learn.bitbybit.dev/openapi.json) - OpenAPI 3.1.0, machine-readable, import it into Postman, Insomnia, an SDK generator or an AI agent |
...
All model parameters are optional - default values produce a valid model. See the [API reference](/api/openapi-docs/bitbybit-cad-cloud-api) for full parameter documentation.
...
For full request/response schemas, see the [API reference](/api/openapi-docs/bitbybit-cad-cloud-api).
