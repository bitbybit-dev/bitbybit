...
image: https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/introducing-bitbybit-runner.jpeg
authors: [ubarevicius]
tags: [bitbybit, cad]
...
![Runner is on the loose. A free and powerful tiger in the jungle playing with soap bubbles, symbolizing the freedom to run scripts anywhere.](https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/introducing-bitbybit-runner.jpeg "Runner is on the loose. Run your scripts wherever you are on the internet")
...
![The "Export to Runner" button location within the Bitbybit.dev editor interface.](https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/export-to-runner.jpeg "Button to export script to the runner. It is available for all editors - Rete, Blockly and TypeScript")
...
![The dialog showing the generated JavaScript code ready to be used with BITBYBIT-RUNNER.JS.](https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/export-to-runner-dialog.jpeg "Dialog that shows prepared code for the runner")
...
![JSFiddle code editor showing the output of an alloy wheel CAD model designed with Bitbybit.dev and run via BITBYBIT-RUNNER.JS.](https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/jsfiddle-example.jpeg "Alloy wheel CAD 3D model design on JSFiddle")
...
![CodePen editor showing a 3D slide with a Havok physics simulation of rolling balls, coded using BITBYBIT-RUNNER.JS.](https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/codepen-example.jpeg "3D slide with Havok physics simulation on CodePen")
...
![StackBlitz code editor showing a simple 3D model configurator that interacts with an exported Rete script via BITBYBIT-RUNNER.JS.](https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/stackblitz-example.jpeg "Simple 3D model configurator on StackBlitz that interacts with Rete script")
...
![Rete editor components that read inputs for the runner. These might appear to return 'undefined' in the editor but get populated by the runner.](https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/rete-editor-runner-inputs2.jpeg "Rete editor components that read the inputs of the runner when executed in the runner")
...
![Rete editor components that write outputs from the script, which can then be retrieved by the runner.](https://bitbybit.dev/files/site/blog/introducing-bitbybit-runner/rete-editor-runner-outputs2.jpeg "Rete editor components that write outputs to be read by the runner")
