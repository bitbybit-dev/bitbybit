...
image: https://bitbybit.dev/files/site/blog/releases/bitbybit-dev-release-v0-15-5.jpeg
authors: [ubarevicius]
tags: [bitbybit, cad]
...
![A visual representation of new features in Bitbybit.dev v0.15.5, showcasing complex geometric constructions.](https://bitbybit.dev/files/site/blog/releases/bitbybit-dev-release-v0-15-5.jpeg "New features in action.")
