...
image: https://bitbybit.dev/files/site/blog/releases/bitbybit-dev-release-v0-15-7.jpeg
authors: [ubarevicius]
tags: [bitbybit, cad]
...
![A visual representation of new features in Bitbybit.dev v0.15.7, possibly showing circles created through tangential constraints.](https://bitbybit.dev/files/site/blog/releases/bitbybit-dev-release-v0-15-7.jpeg "New features in action.")
