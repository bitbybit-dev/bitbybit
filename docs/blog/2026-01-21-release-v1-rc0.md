...
image: https://ik.imagekit.io/bitbybit/app/assets/blog/v1-rc0/bitbybit-dev-cad-v1-rc0-banner.webp
authors: [ubarevicius]
...
The 3D engine dependencies have also been updated: **BabylonJS v8.46.2** and **PlayCanvas v2.20.0** are now included in the latest runners.
