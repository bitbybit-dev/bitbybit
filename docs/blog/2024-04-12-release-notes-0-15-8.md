...
image: https://bitbybit.dev/files/site/blog/releases/bitbybit-dev-release-v0-15-8.jpeg
authors: [ubarevicius]
tags: [bitbybit, cad]
...
![New improvements in quality should bring more peace to developers.](https://bitbybit.dev/files/site/blog/releases/bitbybit-dev-release-v0-15-8.jpeg "New improvements in quality should bring more peace to developers.")
