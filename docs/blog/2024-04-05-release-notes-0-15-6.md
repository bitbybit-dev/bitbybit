...
image: https://bitbybit.dev/files/site/blog/releases/bitbybit-dev-release-v0-15-6.jpeg
authors: [ubarevicius]
tags: [bitbybit, cad]
...
![A visual representation of new features in Bitbybit.dev v0.15.6, showcasing complex geometries created from circular elements.](https://bitbybit.dev/files/site/blog/releases/bitbybit-dev-release-v0-15-6.jpeg "New features in action.")
