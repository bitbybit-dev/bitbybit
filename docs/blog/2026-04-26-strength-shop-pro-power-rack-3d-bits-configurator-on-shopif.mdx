...
When they asked whether 3D Bits could interpret and communicate with a fully custom-built UI, the answer was yes - as long as their developers followed the web standards and HTML input guidelines outlined in our [documentation](/learn/3d-bits/how-it-works). 3D Bits is designed to listen for changes on standard HTML inputs (`<input>`, `<select>`, etc.), which means any front-end framework or custom implementation can drive the 3D scene without special adapters.
