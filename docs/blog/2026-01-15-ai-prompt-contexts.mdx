...
authors: [ubarevicius]
description: Download ready-made AI prompt contexts that teach ChatGPT, Claude and other
  coding assistants the full Bitbybit API, so they generate working 3D CAD code for the
  Monaco editor, BabylonJS, Three.js and PlayCanvas.
