...
:::tip Which format should I choose?
- **Markdown Full Context** - Best for beginners. Includes explanations, setup guides, and complete API reference.
- **Markdown Lite Context** - Best for experienced developers. Minimal size, just API definitions.
- **TypeScript .d.ts** - Best for AI agents that struggle with dictionary translation, or agents that support lookahead reading.
:::
