...
This mindset has transformed how Shopify merchants approach 3D product pages using the **3D Bits** app. By thinking like a game designer, you can create immersive, interactive experiences that engage shoppers and showcase your products in unique ways.

## Why Think Like a Game Designer?

### Products Solve Problems
Your product isn’t just a “thing.” It fulfills a desire or solves a problem. A gamified product page lets users experience that value interactively. Think of your product page as a level in a game-an invitation for shoppers to explore, play, and immerse themselves in the experience. With smart storytelling and interactivity, you can make your product page more engaging than visiting a physical store.
...
Modern devices can handle a lot, but don’t push it-especially on mobile. Use lightweight, lower-poly models as abstractions of production-grade CAD designs. Learn more about asset preparation in the [3D Assets](/learn/3d-bits/3d-assets/intro) section.
...
### BITBYBIT VIEWER
The **Composer** functionality allows you to:
...
* Price what the shopper configures, and let Shopify charge it at checkout.

Learn how to build all of this in [Composer](/learn/3d-bits/composer).

### Scripting

When swapping between prepared models is not enough, write TypeScript against the inner features of the BabylonJS engine and let the geometry be calculated as the shopper configures. Add the program as a **Script** in the 3D Bits admin, link it into a Composer project's **Scripting** section, and publish. Scripts need the Standard or Pro plan. See [Scripting](/learn/3d-bits/composer/scripting).

:::warning The RUNNER block is the old route
The theme editor lists it as **BITBYBIT RUNNER (legacy)** and shows a deprecation note in its settings. It keeps working for existing setups, but do not start anything new there - see [BITBYBIT RUNNER (legacy)](/learn/3d-bits/theme-blocks/bitbybit-runner).
:::

## Conclusion

Thinking like a game designer can elevate your 3D product pages from static displays to immersive experiences. Whether you're showcasing a single model or building a complex configurator, the **3D Bits** app provides the tools to bring your vision to life. For more tips on asset preparation, visit the [3D Assets](/learn/3d-bits/3d-assets/intro) section.
