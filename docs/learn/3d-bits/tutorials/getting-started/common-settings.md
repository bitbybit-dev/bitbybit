...
**Default:** `https://cdn.jsdelivr.net/gh/bitbybit-dev/bitbybit-assets@0.21.0/runner/bitbybit-runner-babylonjs.js`
...
Replace `{VERSION}` with the desired version number (e.g., `0.21.0`).
