...
*   **Exposing as a Product with "3D Bits":** Using our "3D Bits" app (likely the [BITBYBIT VIEWER block](/learn/3d-bits/theme-blocks/bitbybit-viewer)) to display the 3D scan on your product page.
