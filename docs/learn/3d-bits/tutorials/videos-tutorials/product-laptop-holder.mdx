...
*   Integrate this script into your Shopify product page using the "3D Bits" app (via [BITBYBIT RUNNER](/learn/3d-bits/theme-blocks/bitbybit-runner)).
*   Ensure your 3D model dynamically updates based on the shopper's selection of these multiple variants.
...
![A screenshot of the 3D parametric laptop holder model as it appears in the Shopify store.](https://bitbybit.dev/files/site/start/shopify/3dlaptopholder.jpeg "3D Laptop Holder Screenshot")
