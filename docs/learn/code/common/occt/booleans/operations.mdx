...
*   **Before Union:**
    ![Three separate, overlapping solid shapes (e.g., a box, cylinder, and sphere) before a union operation.](https://bitbybit.dev/files/site/start/general/editor-categories/non-unioned.jpeg "Non-unioned result of 3 solids")
    *Non-unioned result of 3 solids*

*   **After Union:**
    ![A single solid shape resulting from the union of the three previous solids, with new edges formed at the intersections.](https://bitbybit.dev/files/site/start/general/editor-categories/unioned.jpeg "Unioned result of 3 solids")
...
*   **Before Difference:**
    ![Three overlapping shapes (a box, cylinder, and sphere) before a difference operation.](https://bitbybit.dev/files/site/start/general/editor-categories/before-difference.jpeg "Shapes before difference is computed")
    *Before difference is computed*

*   **After Difference (Box - (Cylinder + Sphere)):**
    ![The box shape with the volumes of the cylinder and sphere subtracted from it.](https://bitbybit.dev/files/site/start/general/editor-categories/after-difference.jpeg "Result after difference operation")
...
*   **Before Intersection:**
    ![Three overlapping shapes (a box, cylinder, and sphere) before an intersection operation.](https://bitbybit.dev/files/site/start/general/editor-categories/before-intersection.jpeg "Shapes before intersection is computed")
    *Before intersection is computed*

*   **After Intersection:**
    ![The common overlapping volume of the box, cylinder, and sphere, resulting in a new shape (or shapes).](https://bitbybit.dev/files/site/start/general/editor-categories/after-intersection.jpeg "Result after intersection operation")
