...
![A 3D solid box with several of its edges rounded by fillet operations of varying radii.](https://bitbybit.dev/files/site/start/general/editor-categories/variable-fillet.jpeg "Fillets on a 3D solid")
