...
![A 2D wire (polyline) with different fillet radii applied to its various corners, creating a mix of sharper and more rounded transitions.](https://bitbybit.dev/files/site/start/general/editor-categories/variable-fillet-wire.jpeg "Fillets with variable radii on a 2D wire")
