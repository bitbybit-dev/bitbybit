...
![A 3D solid box with several of its edges beveled by chamfer operations.](https://bitbybit.dev/files/site/start/general/editor-categories/chamfer.jpeg "Chamfer on a 3D solid")
