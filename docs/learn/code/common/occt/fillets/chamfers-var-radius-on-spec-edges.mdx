...
![A 3D solid box with chamfers of varying distances applied to different edges, creating a mix of larger and smaller beveled surfaces.](https://bitbybit.dev/files/site/start/general/editor-categories/variable-chamfer.jpeg "Variable distance chamfer on a 3D solid")
