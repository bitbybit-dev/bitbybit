...
<html lang="en">
  <head>
    ...
    <script src="https://git-cdn.bitbybit.dev/latest/runner/bitbybit-runner-babylonjs.js"></script> {/* Ensure version is current */}
    ...
    <div className="example">
      ...
      <div className="actions">
        <div>
          ...
          <span className="label" id="radius1">Radius1 is 4</span>
        ...
        <div>
          ...
          <span className="label" id="radius2">Radius2 is 2</span>
        ...
        <div>
          ...
          <span className="label" id="distance">Distance is 24</span>
