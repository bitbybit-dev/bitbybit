...
<html lang="en">
  <head>
    ...
    <script src="https://cdn.jsdelivr.net/gh/bitbybit-dev/bitbybit-assets@0.20.4/runner/bitbybit-runner-babylonjs.js"></script> {/* Ensure version is current */}
