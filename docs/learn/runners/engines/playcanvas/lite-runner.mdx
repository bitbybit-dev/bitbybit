...
<head>
    ...
    <script src='https://code.playcanvas.com/playcanvas-2.20.0.min.js'></script>
    <script type="module">
    ...
    <script defer
        src="https://git-cdn.bitbybit.dev/latest/runner/bitbybit-runner-lite-playcanvas.js"></script>
    <script type="module">
...
### Lite Runner Script
```html
<script defer src="https://git-cdn.bitbybit.dev/latest/runner/bitbybit-runner-lite-playcanvas.js"></script>
```
