...
description: Learn how to create a 3D website using Bitbybit Runner by integrating a TypeScript program built with Bitbybit.dev into a StackBlitz project.
...
TypeScript is a powerful programming language that enables the expression of complex ideas in a concise and type-safe manner. In this tutorial, Matas Ubarevicius demonstrates building a simple 3D cube using **TypeScript** with the Bitbybit.dev libraries and then integrating this code into a web application using the `bitbybit-runner.js` library.

The focus is on a simple OCCT cube geometry. The primary goal is to illustrate how you can integrate your 3D TypeScript code, developed with Bitbybit.dev, into standard JavaScript web development workflows, leveraging the Bitbybit Runner for execution.
...
The following is the Bitbybit.dev TypeScript script we'll be creating. The JavaScript code used in the StackBlitz example is what gets generated (or is very similar to what you'd write directly) when you use the "Export to Runner" feature from this TypeScript script, or adapt it for the runner environment.
...
This tutorial showcases how TypeScript, combined with Bitbybit.dev's libraries and the Bitbybit Runner, provides a robust and flexible environment for developing sophisticated 3D web applications. By exporting or adapting your TypeScript logic, you can integrate complex 3D operations and CAD functionalities into any standard web project.