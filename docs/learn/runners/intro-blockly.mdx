...
Creating your own 3D websites and configurators can be challenging. At Bitbybit, we aim to simplify this process and make it cost-effective with our low-code solutions. In this tutorial, Matas Ubarevicius demonstrates how to build a visual program using the **Blockly editor** on our web CAD platform and then integrate it to run on a third-party coding environment, specifically [StackBlitz](https://stackblitz.com/).
