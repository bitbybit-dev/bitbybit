      ...
      <Tabs>
        <TabItem value="monaco" label="Monaco Editor" default>
          <div style={{ padding: '20px', background: 'linear-gradient(135deg, rgba(240, 206, 187, 0.1) 0%, rgba(30, 32, 36, 0.8) 100%)', borderRadius: '12px', border: '1px solid rgba(240, 206, 187, 0.3)', marginBottom: '20px' }}>
            ...
            <div>
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-babylon-monaco-ai-context-v${version}.md`} label="Monaco Context" variant="full" />
            </div>
            <h5 style={{ marginTop: '16px', marginBottom: '12px', color: 'var(--ifm-font-color-base)' }}>TypeScript Declarations (No Translation)</h5>
            <div>
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-babylon-formatted-v${version}.d.ts`} label=".d.ts with Comments" variant="full" />
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-babylon-formatted-no-comments-v${version}.d.ts`} label=".d.ts without Comments" variant="lite" />
            </div>
          </div>
        </TabItem>
        <TabItem value="babylonjs" label="BabylonJS">
          <div style={{ padding: '20px', background: 'linear-gradient(135deg, rgba(187, 70, 75, 0.1) 0%, rgba(30, 32, 36, 0.8) 100%)', borderRadius: '12px', border: '1px solid rgba(187, 70, 75, 0.3)', marginBottom: '20px' }}>
            ...
            <div>
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-babylon-ai-context-v${version}.md`} label="Full Context" variant="full" />
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-babylon-no-comment-min-ai-v${version}.md`} label="Lite Context" variant="lite" />
            </div>
          </div>
        </TabItem>
        <TabItem value="threejs" label="ThreeJS">
          <div style={{ padding: '20px', background: 'linear-gradient(135deg, rgba(4, 158, 244, 0.1) 0%, rgba(30, 32, 36, 0.8) 100%)', borderRadius: '12px', border: '1px solid rgba(4, 158, 244, 0.3)', marginBottom: '20px' }}>
            ...
            <div>
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-three-ai-context-v${version}.md`} label="Full Context" variant="full" />
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-three-no-comment-min-ai-v${version}.md`} label="Lite Context" variant="lite" />
            </div>
          </div>
        </TabItem>
        <TabItem value="playcanvas" label="PlayCanvas">
          <div style={{ padding: '20px', background: 'linear-gradient(135deg, rgba(255, 107, 53, 0.1) 0%, rgba(30, 32, 36, 0.8) 100%)', borderRadius: '12px', border: '1px solid rgba(255, 107, 53, 0.3)', marginBottom: '20px' }}>
            ...
            <div>
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-playcanvas-ai-context-v${version}.md`} label="Full Context" variant="full" />
              <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-playcanvas-no-comment-min-ai-v${version}.md`} label="Lite Context" variant="lite" />
            </div>
          </div>
        </TabItem>
      </Tabs>
    ...
    <Tabs>
      ...
      <TabItem value="threejs-dts" label="ThreeJS">
        <div style={{ padding: '20px', background: 'linear-gradient(135deg, rgba(4, 158, 244, 0.1) 0%, rgba(30, 32, 36, 0.8) 100%)', borderRadius: '12px', border: '1px solid rgba(4, 158, 244, 0.3)', marginBottom: '20px' }}>
          ...
          <p style={{ color: 'var(--ifm-font-color-base)', opacity: 0.8, marginBottom: '20px' }}>TypeScript definitions with full, unabbreviated names</p>
          <div>
            <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-three-formatted-v${version}.d.ts`} label=".d.ts with Comments" variant="full" />
            <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-three-formatted-no-comments-v${version}.d.ts`} label=".d.ts without Comments" variant="lite" />
          </div>
        </div>
      </TabItem>
      <TabItem value="playcanvas-dts" label="PlayCanvas">
        <div style={{ padding: '20px', background: 'linear-gradient(135deg, rgba(255, 107, 53, 0.1) 0%, rgba(30, 32, 36, 0.8) 100%)', borderRadius: '12px', border: '1px solid rgba(255, 107, 53, 0.3)', marginBottom: '20px' }}>
          ...
          <p style={{ color: 'var(--ifm-font-color-base)', opacity: 0.8, marginBottom: '20px' }}>TypeScript definitions with full, unabbreviated names</p>
          <div>
            <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-playcanvas-formatted-v${version}.d.ts`} label=".d.ts with Comments" variant="full" />
            <DownloadButton href={`https://git-cdn.bitbybit.dev/v${version}/ai-context/bitbybit-playcanvas-formatted-no-comments-v${version}.d.ts`} label=".d.ts without Comments" variant="lite" />
          </div>
        </div>
      </TabItem>
    </Tabs>
