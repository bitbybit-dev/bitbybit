...
1.  **Find the "Manage Local Assets" Button:**
    ...
    ![The "Manage Local Assets" button, usually depicted as a folder icon, in the Bitbybit editor interface.](https://bitbybit.dev/files/site/start/general/assets/local/local-asset-icon.jpeg "Button To Manage Local Assets")
...
2.  **Open the Local Asset Manager Dialog:**
    ...
    ![The initial dialog for managing local assets, showing an option to upload files.](https://bitbybit.dev/files/site/start/general/assets/local/upload-local-asset.jpeg "Dialog for uploading local assets")
...
3.  **Prepare to Upload:**
    ...
    *   **Choose File(s):** Click the "Choose files" (or similar) button. This will open your computer's file navigator.
    ...
    ![The form within the local asset manager for naming the asset and choosing a file to upload.](https://bitbybit.dev/files/site/start/general/assets/local/upload-local-asset-form.jpeg "Form For Local Asset")
...
6.  **View Uploaded Asset:**
    ...
    *   Potentially download previously uploaded local assets from your browser back to your computer's file system.
    ...
    ![The local asset manager dialog showing the "BoomBox" asset successfully uploaded and listed.](https://bitbybit.dev/files/site/start/general/assets/local/uploaded.jpeg "Local Asset Manager With Uploaded BoomBox Asset")
