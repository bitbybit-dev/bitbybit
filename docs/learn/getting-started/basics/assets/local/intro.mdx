...
*   **Sharing Limitations:**
    *   If your script relies on local assets and you [export the script to a file](/learn/getting-started/basics/scripts/save-to-file) to share with others, those users will **not** automatically have the asset. You would need to provide them with the asset file separately, and they would have to upload it as a local asset in their own browser.
...
1.  **Uploading Local Assets:**
    ...
    *   ➡️ [Uploading Local Assets Guide](/learn/getting-started/basics/assets/local/uploading)
...
2.  **Using a Local glTF File (Gaming Standard):**
    ...
    *   ➡️ [Local glTF Asset Tutorial](/learn/getting-started/basics/assets/local/gltf)
...
3.  **Using a Local STEP File (CAD Standard):**
    ...
    *   ➡️ [Local STEP Asset Tutorial](/learn/getting-started/basics/assets/local/step)
