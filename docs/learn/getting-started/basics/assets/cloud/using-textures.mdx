...
*   [dogs-small.jpeg](https://bitbybit.dev/files/site/start/general/assets/cloud/dogs-small.jpeg) (Click to view/download)

![A photograph of several dogs, which will be used as a texture.](https://bitbybit.dev/files/site/start/general/assets/cloud/dogs-small.jpeg "Image of dogs for texture")
