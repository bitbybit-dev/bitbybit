...
![An image showing a list of scripts contained within a Bitbybit project.](https://bitbybit.dev/files/site/start/general/projects/scripts-within-project.jpeg "Scripts within project")
