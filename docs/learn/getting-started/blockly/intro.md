...
![Logo of Blockly](https://bitbybit.dev/files/site/start/blockly/blockly-logo.svg)
*Blockly Logo*
...
![Example of Blockly component composition from one of the Bitbybit Developers scripts](https://bitbybit.dev/files/site/start/blockly/blockly-composition-example.webp)
...
1.  **Run the Script:**
    ...
    ![Picture shows how to run Bitbybit Developers Blockly based script](https://bitbybit.dev/files/site/start/blockly/logo-script-editor-run.webp)
    *Run Script Button*
...
2.  **Enter the 3D View:**
    ...
    ![Picture shows how to enter the 3D environment of the script result](https://bitbybit.dev/files/site/start/blockly/logo-script-editor-swap-canvas.webp)
    *Swap Canvas Button*
...
3.  **Interact with the 3D Scene:**
    ...
    ![Picture shows how to click 3D object of the logo in the scene](https://bitbybit.dev/files/site/start/blockly/logo-script-editor-3d-click.webp)
