...
This tutorial builds upon the previous one. To understand this section fully, you should have already completed the [Uploading Cloud Assets](/start/getting-started/basics/assets/cloud/uploading) tutorial.
