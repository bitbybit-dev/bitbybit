...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    app_menu_more_clean_all_cache: 'Clean Cache',
    ...
    app_menu_more_examples_street_smart_flower_light_title: 'Flower light',
    app_menu_more_examples_street_smart_flower_light_description: 'Composition that could be used to create a nice lighting environment for your room. This example shows how you can generate iterative parametric solid structures just by using few transformations.',
    ...
    block_toolbox_category_geom_point_draw: 'Draw',
    ...
    block_toolbox_category_geom_base: 'Basic',
    ...
    block_toolbox_category_intersect: 'Intersection',
    ...
    block_toolbox_category_3d_text: '3D Text',
    ...
    block_toolbox_category_apply_transform: 'Transform',
    ...
    block_toolbox_category_occ_wire: 'Wire',
    block_toolbox_category_occ_face: 'Face',
    block_toolbox_category_occ_apply: 'Apply',
    block_toolbox_category_occ_shapes: 'Shapes',
    block_toolbox_category_occ_operation: 'Operations',
    block_toolbox_category_occ_boolean: 'Booleans',
    block_toolbox_category_occ_transform: 'Transforms',
    block_toolbox_category_occ_edge: 'Edge',
    ...
    block_body: 'Body',
    block_point: 'Point',
    block_clockwise: 'Clockwise',
    block_counter_clockwise: 'Counter Clockwise',
    block_delta: 'Delta',
    ...
    block_base: 'Base',
    block_height: 'Height',
    block_extrusion_height: 'Extrusion Height',
    block_extrusion_size: 'Extrusion Size',
    block_points: 'Points',
    ...
    block_x_offset: 'X Offset',
    block_y_offset: 'Y Offset',
    block_z_offset: 'Z Offset',
    block_extrude_offset: 'Extrude Offset',
    block_line_spacing: 'Line Spacing',
    block_letter_spacing: 'Letter Spacing',
    block_align: 'Align',
    block_input_text: 'Input Text',
    block_radius: 'Radius',
    block_round_radius: 'Round Radius',
    block_start_radius: 'Start Radius',
    block_end_radius: 'End Radius',
    block_radius_x: 'Radius X',
    block_radius_y: 'Radius Y',
    block_radius_z: 'Radius Z',
    block_inner_radius: 'Inner Radius',
    block_outer_radius: 'Outer Radius',
    block_inner_segments: 'Inner Segments',
    block_outer_segments: 'Outer Segments',
    block_inner_rotation: 'Inner Rotation',
    block_outer_rotation: 'Outer Rotation',
    block_vertices: 'Vertices',
    block_density: 'Density',
    block_resolution: 'Resolution',
    block_segments: 'Segments',
    block_include_last: 'Include Last',
    block_include_first: 'Include First',
    ...
    block_y_axis: 'Y Axis',
    block_z_axis: 'Z Axis',
    block_x_axis_rotation: 'X Axis Rotation',
    block_y_axis_rotation: 'Y Axis Rotation',
    block_z_axis_rotation: 'Z Axis Rotation',
    ...
    block_babylon_transformation_rotation_yaw_pitch_roll_input_yaw: 'Rotation with yaw',
    block_babylon_transformation_rotation_yaw_pitch_roll_input_pitch: 'Pitch',
    block_babylon_transformation_rotation_yaw_pitch_roll_input_roll: 'Roll',
    block_babylon_transformation_rotation_yaw_pitch_roll_input_center: 'Around center',
    block_babylon_transformation_rotation_yaw_pitch_roll_description: 'Rotates around center with yaw, pitch and roll angles',
    ...
    block_verb_geometry_nurbs_surface_isocurve_description: 'Gets the isocurve of the surface at u or v parameter.',
    block_verb_geometry_nurbs_surface_isocurves_input_surface: 'Isocurves on the surface',
    block_verb_geometry_nurbs_surface_isocurves_input_parameters: 'At parameters',
    block_verb_geometry_nurbs_surface_isocurves_input_use_v: 'Use v parameter',
    block_verb_geometry_nurbs_surface_isocurves_description: 'Gets the isocurves of the surface at u or v parameters.',
    block_verb_geometry_nurbs_surface_isocurves_subdivision_input_surface: 'Subdivide to isocurves on the surface',
    block_verb_geometry_nurbs_surface_isocurves_subdivision_input_segments: 'Segment count',
    block_verb_geometry_nurbs_surface_isocurves_subdivision_input_include_last: 'Include last',
    block_verb_geometry_nurbs_surface_isocurves_subdivision_input_include_first: 'Include first',
    block_verb_geometry_nurbs_surface_isocurves_subdivision_input_use_v: 'Use v parameter',
    block_verb_geometry_nurbs_surface_isocurves_subdivision_description: 'Gets the isocurves of the surface at u or v parameters.',
    ...
    block_babylon_node_get_rotation_transformation_input_node: 'Rotation transformation for node',
    block_babylon_node_get_rotation_transformation_description: 'Gets nodes\' rotation transformation.',
    ...
    block_babylon_node_get_absolute_rotation_transformation_input_node: 'Absolute rotation transformation for node',
    block_babylon_node_get_absolute_rotation_transformation_description: 'Get absolute rotation transformation from the node',
    ...
    block_jscad_primitive_2d_rectangle_input_center: 'Rectangle polygon with center point',
    block_jscad_primitive_2d_rectangle_input_width: 'Width',
    block_jscad_primitive_2d_rectangle_input_length: 'Length',
    block_jscad_primitive_2d_rectangle_description: 'Creates a rectangle polygon on the center point of given dimensions.',
    block_jscad_extrude_linear_polygon_input_polygon: 'Linear extrusion of polygon',
    block_jscad_extrude_linear_polygon_input_height: 'Height',
    block_jscad_extrude_linear_polygon_input_twist_angle: 'Twist angle',
    block_jscad_extrude_linear_polygon_input_twist_steps: 'Twist steps',
    block_jscad_extrude_linear_polygon_description: 'Exrudes linearly the polygon into the given height, twist angle and steps.',
    block_jscad_extrude_linear_polygon_objects_input_polygons: 'Linear extrusion of polygons',
    block_jscad_extrude_linear_polygon_objects_input_height: 'Height',
    block_jscad_extrude_linear_polygon_objects_input_twist_angle: 'Twist angle',
    block_jscad_extrude_linear_polygon_objects_input_twist_steps: 'Twist steps',
    block_jscad_extrude_linear_polygon_objects_description: 'Linearly exrudes the polygons into the given height, twist angle and steps.',
    block_jscad_primitive_2d_polygon_from_points_input_points: 'Polygon from XY points',
    block_jscad_primitive_2d_polygon_from_points_description: 'Creates a polygon when given a list of XY points',
    block_jscad_primitive_2d_polygon_from_polyline_input_polyline: 'Polygon from XY polyline',
    block_jscad_primitive_2d_polygon_from_polyline_description: 'Creates a polygon when given XY polyline',
    block_jscad_primitive_2d_polygon_from_curve_input_curve: 'Polygon from XY curve',
    block_jscad_primitive_2d_polygon_from_curve_description: 'Creates a polygon when given XY curve',
    block_jscad_primitive_2d_polygon_from_path_input_path: 'Polygon from XY path',
    block_jscad_primitive_2d_polygon_from_path_description: 'Creates a polygon when given XY path',
    block_jscad_transform_input_csg_mesh: 'Transform solid',
    block_jscad_transform_input_transformation: 'Transformation',
    block_jscad_transform_description: 'Transforms the solid mesh with a transformation',
    block_jscad_transform_solids_input_solids: 'Transform solids',
    block_jscad_transform_solids_input_transformation: 'Transformation',
    block_jscad_transform_solids_description: 'Transforms the solids with a transformation',
    block_jscad_sphere_input_center: 'Sphere on the center point',
    block_jscad_sphere_input_radius: 'Radius',
    block_jscad_sphere_input_segments: 'Segments',
    block_jscad_sphere_description: 'Creates the solid sphere on the center point of given segment count.',
    block_jscad_cube_input_center: 'Cube on the center point',
    block_jscad_cube_input_size: 'Size',
    block_jscad_cube_description: 'Creates the solid cube of given size on the center point.',
    block_jscad_subtract_input_subtract_from_object: 'From solid',
    block_jscad_subtract_input_subtract_object: 'Subtract solid',
    block_jscad_subtract_description: 'Subtracts the object from object',
    block_jscad_subtract_objects_from_solid_input_objects: 'Subtract solids',
    block_jscad_subtract_objects_from_solid_input_solid: 'From solid',
    block_jscad_subtract_objects_from_solid_description: 'Subtracts the solids from a single solid.',
    block_jscad_union_input_union_object: 'Union solid',
    block_jscad_union_input_with_object: 'With solid',
    block_jscad_union_description: 'Union two solids together.',
    block_jscad_intersect_input_intersect_object: 'Intersect solid',
    block_jscad_intersect_input_with_object: 'With solid',
    block_jscad_intersect_description: 'Intersects two solids and returns the result.',
    block_jscad_color_input_color: 'Apply colour',
    block_jscad_color_input_object: 'To solid',
    block_jscad_color_description: 'Applies colour to solid object',
    block_jscad_cuboid_input_center: 'Cuboid on the center point',
    block_jscad_cuboid_input_width: 'Width',
    block_jscad_cuboid_input_length: 'Length',
    block_jscad_cuboid_input_height: 'Height',
    block_jscad_cuboid_description: 'Creates a cuboid on the center point.',
    block_jscad_union_objects_input_objects: 'Union solids',
    block_jscad_union_objects_description: 'Creates the union of the list of solids.',
    block_jscad_subtract_objects_input_objects: 'Subtract solids',
    block_jscad_subtract_objects_description: 'Subtracts a list of solids',
    block_jscad_intersect_objects_input_objects: 'Intersect solids',
    block_jscad_intersect_objects_description: 'Intersects a list of solids',
    block_jscad_extrude_rectangular_points_input_points: 'Rectangular extrusion path of XY points',
    block_jscad_extrude_rectangular_points_input_height: 'Height',
    block_jscad_extrude_rectangular_points_input_size: 'Size',
    block_jscad_extrude_rectangular_points_description: 'Creates rectangular extrusion of path formed by XY points.',
    block_jscad_extrude_rectangular_path_input_path: 'Rectangular extrusion of XY path',
    block_jscad_extrude_rectangular_path_input_height: 'Height',
    block_jscad_extrude_rectangular_path_input_size: 'Size',
    block_jscad_extrude_rectangular_path_description: 'Creates rectangular extrusion of the path.',
    block_jscad_extrude_rectangular_paths_input_paths: 'Rectangular extrusion of XY paths',
    block_jscad_extrude_rectangular_paths_input_height: 'Height',
    block_jscad_extrude_rectangular_paths_input_size: 'Size',
    block_jscad_extrude_rectangular_paths_description: 'Creates rectangular extrusions of the multiple paths.',
    block_jscad_primitive_2d_path_from_points_input_points: 'Path from XY points',
    block_jscad_primitive_2d_path_from_points_input_closed: 'Closed',
    block_jscad_primitive_2d_path_from_points_description: 'Creates a XY path from given points.',
    block_jscad_primitive_2d_path_close_input_close: 'Close the XY path',
    block_jscad_primitive_2d_path_close_description: 'Closes XY path by joining last point with the first point.',
    block_jscad_primitive_2d_path_append_points_input_path: 'Append path',
    block_jscad_primitive_2d_path_append_points_input_points: 'With points',
    block_jscad_primitive_2d_path_append_points_description: 'Appends path with points',
    block_jscad_primitive_2d_path_append_arc_input_path: 'Append arc to path',
    block_jscad_primitive_2d_path_append_arc_input_end_point: 'With XY end point',
    block_jscad_primitive_2d_path_append_arc_input_radius_x: 'X radius',
    block_jscad_primitive_2d_path_append_arc_input_radius_y: 'Y radius',
    block_jscad_primitive_2d_path_append_arc_input_x_axis_rotation: 'X axis rotation',
    block_jscad_primitive_2d_path_append_arc_input_clockwise: 'Clockwise',
    block_jscad_primitive_2d_path_append_arc_input_large: 'Large',
    block_jscad_primitive_2d_path_append_arc_input_segments: 'Segment count',
    block_jscad_primitive_2d_path_append_arc_description: 'Extends the path with an arc of given parameters.',
    block_jscad_primitive_2d_path_append_polyline_input_path: 'Append path',
    block_jscad_primitive_2d_path_append_polyline_input_polyline: 'With polyline',
    block_jscad_primitive_2d_path_append_polyline_description: 'Appends path with polyline.',
    block_jscad_primitive_2d_path_append_curve_input_path: 'Append path',
    block_jscad_primitive_2d_path_append_curve_input_curve: 'With curve',
    block_jscad_primitive_2d_path_append_curve_description: 'Appends path with curve that gets tessellated into points.',
    block_jscad_primitive_2d_path_empty_input_path: 'Empty path',
    block_jscad_primitive_2d_path_empty_description: 'Creates empty path that can be appended with various entities',
    block_jscad_primitive_2d_path_from_polyline_input_polyline: 'Path from XY polyline',
    block_jscad_primitive_2d_path_from_polyline_input_closed: 'Closed',
    block_jscad_primitive_2d_path_from_polyline_description: 'Creates a path from polyline.',
    block_jscad_primitive_2d_path_from_curve_input_curve: 'Path from XY curve',
    block_jscad_primitive_2d_path_from_curve_input_closed: 'Closed',
    block_jscad_primitive_2d_path_from_curve_description: 'Creates a path from curve.',
    block_jscad_extrude_rotate_polygon_input_polygon: 'Rotational extrusion of the polygon',
    block_jscad_extrude_rotate_polygon_input_angle: 'Angle',
    block_jscad_extrude_rotate_polygon_input_start_angle: 'Start angle',
    block_jscad_extrude_rotate_polygon_input_segments: 'Segment count',
    block_jscad_extrude_rotate_polygon_description: 'Creates rotational extrusion of the polygon.',
    block_jscad_hull_paths_input_paths: 'Hull paths',
    block_jscad_hull_paths_description: 'Hulls paths together into one path.',
    block_jscad_hull_polygons_input_polygons: 'Hull polygons',
    block_jscad_hull_polygons_description: 'Hulls polygons together into one polygon.',
    block_jscad_hull_solids_input_solids: 'Hull solids',
    block_jscad_hull_solids_description: 'Hulls solids into one solid.',
    block_jscad_chain_hull_paths_input_paths: 'Chain hull paths',
    block_jscad_chain_hull_paths_description: 'Chain hulls paths into a single path boundary.',
    block_jscad_chain_hull_polygons_input_polygons: 'Chain hull polygons',
    block_jscad_chain_hull_polygons_description: 'Chain hulls polygons into a single polygon boundary.',
    block_jscad_chain_hull_solids_input_solids: 'Chain hull solids',
    block_jscad_chain_hull_solids_description: 'Chain hulls solids into a single solid boundary.',
    block_jscad_corner_type_input_round: 'round',
    block_jscad_corner_type_input_chamfer: 'chamfer',
    block_jscad_corner_type_input_edge: 'edge',
    block_jscad_expansions_expand_path_input_path: 'Expand to polygon the path',
    block_jscad_expansions_expand_path_input_delta: 'Delta',
    block_jscad_expansions_expand_path_input_corners: 'Corner type',
    block_jscad_expansions_expand_path_input_segments: 'Segment count',
    block_jscad_expansions_expand_path_description: 'Expands the path to polygon with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_expand_polygon_input_polygon: 'Expand polygon',
    block_jscad_expansions_expand_polygon_input_delta: 'Delta',
    block_jscad_expansions_expand_polygon_input_corners: 'Corners',
    block_jscad_expansions_expand_polygon_input_segments: 'Segment count',
    block_jscad_expansions_expand_polygon_description: 'Expands the polygon with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_expand_solid_input_solid: 'Expand solid',
    block_jscad_expansions_expand_solid_input_delta: 'Delta',
    block_jscad_expansions_expand_solid_input_corners: 'Corners',
    block_jscad_expansions_expand_solid_input_segments: 'Segment count',
    block_jscad_expansions_expand_solid_description: 'Expands the solid with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_expand_paths_input_paths: 'Expand to polygons the paths',
    block_jscad_expansions_expand_paths_input_delta: 'Delta',
    block_jscad_expansions_expand_paths_input_corners: 'Corner type',
    block_jscad_expansions_expand_paths_input_segments: 'Segment count',
    block_jscad_expansions_expand_paths_description: 'Expands the paths to polygons with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_expand_polygons_input_polygons: 'Expand polygons',
    block_jscad_expansions_expand_polygons_input_delta: 'Delta',
    block_jscad_expansions_expand_polygons_input_corners: 'Corners',
    block_jscad_expansions_expand_polygons_input_segments: 'Segment count',
    block_jscad_expansions_expand_polygons_description: 'Expands the polygons with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_expand_solids_input_solids: 'Expand solids',
    block_jscad_expansions_expand_solids_input_delta: 'Delta',
    block_jscad_expansions_expand_solids_input_corners: 'Corners',
    block_jscad_expansions_expand_solids_input_segments: 'Segment count',
    block_jscad_expansions_expand_solids_description: 'Expands the solids with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_offset_path_input_delta: 'Delta',
    block_jscad_expansions_offset_path_input_path: 'Offset to polygon the path',
    block_jscad_expansions_offset_path_input_corners: 'Corner type',
    block_jscad_expansions_offset_path_input_segments: 'Segment count',
    block_jscad_expansions_offset_path_description: 'Offsets the path to polygon with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_offset_polygon_input_polygon: 'Offset polygon',
    block_jscad_expansions_offset_polygon_input_delta: 'Delta',
    block_jscad_expansions_offset_polygon_input_corners: 'Corners',
    block_jscad_expansions_offset_polygon_input_segments: 'Segment count',
    block_jscad_expansions_offset_polygon_description: 'Offsets the polygon with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_offset_solid_description: 'Offsets the solid with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_offset_paths_input_paths: 'Offset to polygons the paths',
    block_jscad_expansions_offset_paths_input_delta: 'Delta',
    block_jscad_expansions_offset_paths_input_corners: 'Corner type',
    block_jscad_expansions_offset_paths_input_segments: 'Segment count',
    block_jscad_expansions_offset_paths_description: 'Offsets the paths to polygons with given delta distance, selected corner type and segment count.',
    block_jscad_expansions_offset_polygons_input_polygons: 'Offset polygons',
    block_jscad_expansions_offset_polygons_input_delta: 'Delta',
    block_jscad_expansions_offset_polygons_input_corners: 'Corners',
    block_jscad_expansions_offset_polygons_input_segments: 'Segment count',
    block_jscad_expansions_offset_polygons_description: 'Offsets the polygons with given delta distance, selected corner type and segment count.',
    block_jscad_primitive_2d_circle_input_center: 'Circle polygon',
    block_jscad_primitive_2d_circle_input_radius: 'Radius',
    block_jscad_primitive_2d_circle_input_segments: 'Segment count',
    block_jscad_primitive_2d_circle_description: 'Creates a circle polygon of the given radius and segment count.',
    block_jscad_cylinder_input_center: 'Cylinder on the center point',
    block_jscad_cylinder_input_radius: 'Radius',
    block_jscad_cylinder_input_height: 'Height',
    block_jscad_cylinder_input_segments: 'Segment count',
    block_jscad_cylinder_description: 'Creates a cylinder at a center point of the given radius and height.',
    block_jscad_spheres_on_center_points_input_centers: 'Spheres on the center points',
    block_jscad_spheres_on_center_points_input_radius: 'Radius',
    block_jscad_spheres_on_center_points_input_segments: 'Segment count',
    block_jscad_spheres_on_center_points_description: 'Creates a list of spheres on the center points of given radius and segment count.',
    block_jscad_cylinder_on_center_points_input_centers: 'Cylinders on the center points',
    block_jscad_cylinder_on_center_points_input_radius: 'Radius',
    block_jscad_cylinder_on_center_points_input_height: 'Height',
    block_jscad_cylinder_on_center_points_input_segments: 'Segment count',
    block_jscad_cylinder_on_center_points_description: 'Creates cylinders of given radius, height and segments on the center points.',
    block_jscad_cuboids_on_center_points_input_centers: 'Cuboids on the center points',
    block_jscad_cuboids_on_center_points_input_width: 'Width',
    block_jscad_cuboids_on_center_points_input_length: 'Length',
    block_jscad_cuboids_on_center_points_input_height: 'Height',
    block_jscad_cuboids_on_center_points_description: 'Creates a cuboids of given size on the center points.',
    block_jscad_cubes_on_center_points_input_centers: 'Cubes on the center points',
    block_jscad_cubes_on_center_points_input_size: 'Size',
    block_jscad_cubes_on_center_points_description: 'Create a list of cubes on the center points.',
    block_jscad_primitive_2d_ellipse_input_center: 'Ellipse on the center point',
    block_jscad_primitive_2d_ellipse_input_radius: 'Radius XY',
    block_jscad_primitive_2d_ellipse_input_segments: 'Segment count',
    block_jscad_primitive_2d_ellipse_description: 'Creates given size ellipse on the center point.',
    block_jscad_cylinder_elliptic_input_center: 'Elliptic cylinder on the center point',
    block_jscad_cylinder_elliptic_input_start_radius: 'Start radius XY',
    block_jscad_cylinder_elliptic_input_end_radius: 'End radius XY',
    block_jscad_cylinder_elliptic_input_height: 'Height',
    block_jscad_cylinder_elliptic_input_segments: 'Segment count',
    block_jscad_cylinder_elliptic_description: 'Creates elliptic cylinder with independent start and end radius, height and segment count.',
    block_jscad_cylinders_elliptic_on_center_points_input_centers: 'Elliptic cylinders on the center points',
    block_jscad_cylinders_elliptic_on_center_points_input_start_radius: 'Start radius XY',
    block_jscad_cylinders_elliptic_on_center_points_input_end_radius: 'End radius XY',
    block_jscad_cylinders_elliptic_on_center_points_input_height: 'Height',
    block_jscad_cylinders_elliptic_on_center_points_input_segments: 'Segment count',
    block_jscad_cylinders_elliptic_on_center_points_description: 'Creates elliptic cylinders on the center points with start and end radius, height and segment count.',
    block_jscad_ellipsoid_input_center: 'Ellipsoid on the center point',
    block_jscad_ellipsoid_input_radius: 'Radius',
    block_jscad_ellipsoid_input_segments: 'Segment count',
    block_jscad_ellipsoid_input_axis_x: 'Axis X',
    block_jscad_ellipsoid_input_axis_y: 'Axis Y',
    block_jscad_ellipsoid_input_axis_z: 'Axis Z',
    block_jscad_ellipsoid_description: 'Creates ellipsoid on the center point of given radius and segment count.',
    block_jscad_ellipsoids_on_center_points_input_centers: 'Ellipsoids on the center points',
    block_jscad_ellipsoids_on_center_points_input_radius: 'Radius',
    block_jscad_ellipsoids_on_center_points_input_segments: 'Segment count',
    block_jscad_ellipsoids_on_center_points_description: 'Creates ellipsoids on the center points of the given radius and segment count.',
    block_jscad_geodesic_sphere_input_center: 'Geodesic sphere on the center point',
    block_jscad_geodesic_sphere_input_radius: 'Radius',
    block_jscad_geodesic_sphere_input_frequency: 'Frequency',
    block_jscad_geodesic_sphere_description: 'Creates geodesic sphere on the center point and given frequency.',
    block_jscad_geodesic_spheres_on_center_points_input_centers: 'Geodesic spheres on the center points',
    block_jscad_geodesic_spheres_on_center_points_input_radius: 'Radius',
    block_jscad_geodesic_spheres_on_center_points_input_frequency: 'Frequency',
    block_jscad_geodesic_spheres_on_center_points_description: 'Creates geodesic spheres on the center points with given radius and frequency.',
    block_jscad_rounded_cuboid_input_center: 'Rounded cuboid on the center point',
    block_jscad_rounded_cuboid_input_width: 'Width',
    block_jscad_rounded_cuboid_input_length: 'Length',
    block_jscad_rounded_cuboid_input_height: 'Height',
    block_jscad_rounded_cuboid_input_round_radius: 'Round radius',
    block_jscad_rounded_cuboid_input_segments: 'Segment count',
    block_jscad_rounded_cuboid_description: 'Creates rounded cuboid on the center point of given size and radius.',
    block_jscad_rounded_cuboids_on_center_points_input_centers: 'Rounded cuboids on the center points',
    block_jscad_rounded_cuboids_on_center_points_input_width: 'Width',
    block_jscad_rounded_cuboids_on_center_points_input_length: 'Length',
    block_jscad_rounded_cuboids_on_center_points_input_height: 'Height',
    block_jscad_rounded_cuboids_on_center_points_input_round_radius: 'Round radius',
    block_jscad_rounded_cuboids_on_center_points_input_segments: 'Segment count',
    block_jscad_rounded_cuboids_on_center_points_description: 'Creates rounded cuboids on the center points of given size and radius.',
    block_jscad_rounded_cylinder_input_center: 'Rounded cylinder on the center point',
    block_jscad_rounded_cylinder_input_round_radius: 'Round radius',
    block_jscad_rounded_cylinder_input_radius: 'Radius',
    block_jscad_rounded_cylinder_input_height: 'Height',
    block_jscad_rounded_cylinder_input_segments: 'Segments',
    block_jscad_rounded_cylinder_description: 'Creates a rounded cylinder of given radius and height on the center point.',
    block_jscad_rounded_cylinders_on_center_points_input_centers: 'Rounded cylinders on the center points',
    block_jscad_rounded_cylinders_on_center_points_input_round_radius: 'Round radius',
    block_jscad_rounded_cylinders_on_center_points_input_radius: 'Radius',
    block_jscad_rounded_cylinders_on_center_points_input_height: 'Height',
    block_jscad_rounded_cylinders_on_center_points_input_segments: 'Segments',
    block_jscad_rounded_cylinders_on_center_points_description: 'Creates a rounded cylinders of given radius and height on the center points.',
    block_jscad_primitive_2d_rounded_rectangle_input_center: 'Rounded rectangle on the center point',
    block_jscad_primitive_2d_rounded_rectangle_input_width: 'Width',
    block_jscad_primitive_2d_rounded_rectangle_input_length: 'Length',
    block_jscad_primitive_2d_rounded_rectangle_input_round_radius: 'Round Radius',
    block_jscad_primitive_2d_rounded_rectangle_input_segments: 'Segment count',
    block_jscad_primitive_2d_rounded_rectangle_description: 'Creates rounded rectangle of the given size on the center point.',
    block_jscad_primitive_2d_square_input_center: 'Square on the center point',
    block_jscad_primitive_2d_square_input_size: 'Size',
    block_jscad_primitive_2d_square_description: 'Creates a square of the given size on the center point.',
    block_jscad_primitive_2d_star_input_center: 'Star on the center point',
    block_jscad_primitive_2d_star_input_outer_radius: 'Outer radius',
    block_jscad_primitive_2d_star_input_inner_radius: 'Inner radius',
    block_jscad_primitive_2d_star_input_vertices: 'Vertices',
    block_jscad_primitive_2d_star_input_density: 'Density',
    block_jscad_primitive_2d_star_input_start_angle: 'Start angle',
    block_jscad_primitive_2d_star_description: 'Creates a star polygon on the given center point.',
    block_jscad_torus_input_center: 'Torus on the center point',
    block_jscad_torus_input_inner_radius: 'Inner radius',
    block_jscad_torus_input_outer_radius: 'Outer radius',
    block_jscad_torus_input_inner_segments: 'Inner segment count',
    block_jscad_torus_input_outer_segments: 'Outer segment count',
    block_jscad_torus_input_inner_rotation: 'Inner rotation',
    block_jscad_torus_input_outer_rotation: 'Outer rotation',
    block_jscad_torus_input_start_angle: 'Start angle',
    block_jscad_torus_description: 'Creates a torus of given parameters on the center point.',
    block_jscad_text_vector_cylindrical_text_input_input: 'Cylindric text',
    block_jscad_text_vector_cylindrical_text_input_extrude_height: 'Extrusion height',
    block_jscad_text_vector_cylindrical_text_input_extrude_size: 'Extrusion size',
    block_jscad_text_vector_cylindrical_text_input_segments: 'Segment count',
    block_jscad_text_vector_cylindrical_text_input_x_offset: 'X offset',
    block_jscad_text_vector_cylindrical_text_input_y_offset: 'Y offset',
    block_jscad_text_vector_cylindrical_text_input_height: 'Height',
    block_jscad_text_vector_cylindrical_text_input_line_spacing: 'Line spacing',
    block_jscad_text_vector_cylindrical_text_input_letter_spacing: 'Letter spacing',
    block_jscad_text_vector_cylindrical_text_input_align: 'Align',
    block_jscad_text_vector_cylindrical_text_input_extrude_offset: 'Extrude offset',
    block_jscad_text_vector_cylindrical_text_description: 'Creates a rectangular extrusion of the text.',
    block_jscad_text_vector_spherical_text_input_input: 'Spherical text',
    block_jscad_text_vector_spherical_text_input_radius: 'Radius',
    block_jscad_text_vector_spherical_text_input_segments: 'Segment count',
    block_jscad_text_vector_spherical_text_input_x_offset: 'X offset',
    block_jscad_text_vector_spherical_text_input_y_offset: 'Y offset',
    block_jscad_text_vector_spherical_text_input_height: 'Height',
    block_jscad_text_vector_spherical_text_input_line_spacing: 'Line spacing',
    block_jscad_text_vector_spherical_text_input_letter_spacing: 'Letter spacing',
    block_jscad_text_vector_spherical_text_input_align: 'Align',
    block_jscad_text_vector_spherical_text_input_extrude_offset: 'Extrude offset',
    block_jscad_text_vector_spherical_text_description: 'Creates a rectangular extrusion of the text.',
    block_jscad_text_align_type_input_left: 'Left',
    block_jscad_text_align_type_input_center: 'Center',
    block_jscad_text_align_type_input_right: 'Right',
    block_jscad_io_solid_to_stl_input_solid: 'Download STL from solid',
    block_jscad_io_solid_to_stl_input_file_name: 'File name',
    block_jscad_io_solid_to_stl_description: 'Downloads the STL by giving a single 3D solid.',
    block_jscad_io_solids_to_stl_input_solids: 'Download STL from solids',
    block_jscad_io_solids_to_stl_input_file_name: 'File name',
    block_jscad_io_solids_to_stl_description: 'Downloads the STL by giving a list of 3D solids.',
    block_occt_draw_shape_input_shape: 'Draw OCC shape',
    block_occt_draw_shape_input_precision: 'Mesh precision',
    block_occt_draw_shape_input_draw_faces: 'Draw faces',
    block_occt_draw_shape_input_face_opacity: 'Face opacity',
    block_occt_draw_shape_input_face_colour: 'Face colour',
    block_occt_draw_shape_input_draw_face_indexes: 'Draw face indexes',
    block_occt_draw_shape_input_face_index_height: 'Face index height',
    block_occt_draw_shape_input_face_index_colour: 'Face index colour',
    block_occt_draw_shape_input_draw_edges: 'Draw edges',
    block_occt_draw_shape_input_edge_opacity: 'Edge opacity',
    block_occt_draw_shape_input_edge_colour: 'Edge colour',
    block_occt_draw_shape_input_edge_width: 'Edge width',
    block_occt_draw_shape_input_draw_edge_indexes: 'Draw edge indexes',
    block_occt_draw_shape_input_edge_index_height: 'Edge index height',
    block_occt_draw_shape_input_edge_index_colour: 'Edge index colour',
    block_occt_draw_shape_description: 'Draws OpenCascade shapes from OCC category. Use various properties to configure how the shape should be drawn. Face and edge indexes are useful if you use commands like fillet, chamfer, offset, etc.',
    block_occt_shapes_solid_create_box_input_width: 'Create OCC box of width',
    block_occt_shapes_solid_create_box_input_length: 'Length',
    block_occt_shapes_solid_create_box_input_height: 'Height',
    block_occt_shapes_solid_create_box_input_center: 'Center',
    block_occt_shapes_solid_create_box_description: 'Creates OCC box shape.',
    block_occt_shapes_solid_create_sphere_input_radius: 'Create OCC sphere with radius',
    block_occt_shapes_solid_create_sphere_input_center: 'Center point',
    block_occt_shapes_solid_create_sphere_description: 'Creates OCC sphere shape of the given radius.',
    block_occt_shapes_solid_create_cone_input_radius_one: 'Create OCC cone with base radius',
    block_occt_shapes_solid_create_cone_input_radius_two: 'Top radius',
    block_occt_shapes_solid_create_cone_input_height: 'Height',
    block_occt_shapes_solid_create_cone_description: 'Creates OCC cone of the given height with base and top radius',
    block_occt_shapes_solid_create_cylinder_input_radius: 'Create OCC cylinder with radius',
    block_occt_shapes_solid_create_cylinder_input_height: 'Height',
    block_occt_shapes_solid_create_cylinder_input_center: 'Center',
    block_occt_shapes_solid_create_cylinder_description: 'Creates OCC cylinder with radius, height and the center point.',
    block_occt_shapes_wire_create_bspline_input_points: 'Create BSpline wire through points',
    block_occt_shapes_wire_create_bspline_input_closed: 'Closed',
    block_occt_shapes_wire_create_bspline_description: 'Creates OCC BSpline wire through points',
    block_occt_shapes_wire_create_bezier_input_points: 'Create Bezier wire through points',
    block_occt_shapes_wire_create_bezier_input_closed: 'Closed',
    block_occt_shapes_wire_create_bezier_description: 'Creates OCC Bezier wire through points',
    block_occt_shapes_wire_create_circle_input_radius: 'Create OCC circle wire of radius',
    block_occt_shapes_wire_create_circle_input_center: 'Center',
    block_occt_shapes_wire_create_circle_description: 'Creates OCC circle wire of radius',
    block_occt_shapes_face_create_circle_face_input_radius: 'Create OCC circle face of radius',
    block_occt_shapes_face_create_circle_face_input_center: 'Center',
    block_occt_shapes_face_create_circle_face_description: 'Creates OCC circle face of radius',
    block_occt_operations_offset_input_shape: 'Offset OCC shape',
    block_occt_operations_offset_input_distance: 'distance',
    block_occt_operations_offset_input_tolerance: 'Tolerance',
    block_occt_operations_offset_description: 'Offsets the shape by a given distance.',
    block_occt_operations_extrude_input_shape: 'Extrude OCC shape',
    block_occt_operations_extrude_input_direction: 'Direction',
    block_occt_operations_extrude_description: 'Extrudes OCC shape along the vector.',
    block_occt_operations_loft_input_shapes: 'Loft OCC shapes',
    block_occt_operations_loft_input_make_solid: 'Make solid',
    block_occt_operations_loft_description: 'Creates the loft through shapes',
    block_occt_operations_revolve_input_shape: 'Revolve OCC shape',
    block_occt_operations_revolve_input_angle: 'Angle',
    block_occt_operations_revolve_input_direction: 'Direction',
    block_occt_operations_revolve_input_copy: 'Copy',
    block_occt_operations_revolve_description: 'Revolve the shape around direction by a given degrees.',
    block_occ_fillet_edge_input_shape: 'Fillet edges of the OCC shape',
    ...
    block_occ_fillet_edge_description: 'Fillets the edges of the given solid shape. If all property is true. all edges will be chamfered.',
    block_occt_shapes_edge_chamfer_edges_input_shape: 'Chamfer edges of the OCC shape',
    block_occt_shapes_edge_chamfer_edges_input_distance: 'Distance',
    block_occt_shapes_edge_chamfer_edges_input_edge_list: 'Edge indexes',
    block_occt_shapes_edge_chamfer_edges_input_all: 'All',
    block_occt_shapes_edge_chamfer_edges_description: 'Chamfers the given edges of the shape. If all property is true, all edges will be chamfered.',
    block_occt_booleans_union_input_shapes: 'Union OCC shapes',
    block_occt_booleans_union_input_keep_edges: 'Keep edge indexes',
    block_occt_booleans_union_description: 'Unions multiple shapes together if they are joinable.',
    block_occt_booleans_difference_input_shape: 'Difference between OCC shape',
    block_occt_booleans_difference_input_shapes: 'And shapes',
    block_occt_booleans_difference_input_keep_edges: 'Keep edge indexes',
    block_occt_booleans_difference_description: 'Computes the difference between the shape and other shapes.',
    block_occt_booleans_intersection_input_shapes: 'Intersection between OCC shapes',
    block_occt_booleans_intersection_input_keep_edges: 'Keep edge indexes',
    block_occt_booleans_intersection_description: 'Computes the intersection between all provided shapes.',
    block_occt_shapes_wire_create_polygon_input_points: 'OCC polygon wire through points',
    block_occt_shapes_wire_create_polygon_description: 'Creates the polygon wire through points',
    block_occt_shapes_face_create_polygon_input_points: 'OCC polygon face through points',
    block_occt_shapes_face_create_polygon_description: 'Creates OCC polygon face through points.',
    block_occ_rotate_input_shape: 'Rotate OCC shape',
    block_occ_rotate_input_axis: 'Axis',
    block_occ_rotate_input_angle: 'Angle',
    block_occ_rotate_description: 'Rotates OCC shape around the axis with a given angle.',
    block_occ_scale_input_shape: 'Scale OCC shape',
    block_occ_scale_input_factor: 'Factor',
    block_occ_scale_description: 'Scales the shape uniformly by a given factor from [0,0,0] coordinate.',
    block_occ_translate_input_shape: 'Translate OCC shape',
    block_occ_translate_input_translation: 'Translation vector',
    block_occ_translate_description: 'Translates the OCC shape along the vector.',
    block_occ_transform_input_shape: 'Transform OCC shape',
    block_occ_transform_input_translation: 'Translation vector',
    block_occ_transform_input_rotation_angle: 'Rotation angle',
    ...
    block_occt_operations_rotated_extrude_input_shape: 'Rotated extrude OCC shape',
    block_occt_operations_rotated_extrude_input_height: 'Height',
    block_occt_operations_rotated_extrude_input_angle: 'Angle',
    block_occt_operations_rotated_extrude_description: 'Extrudes OCC shape by rotating it at a given angle and height.',
    block_occt_operations_pipe_input_shape: 'Pipe through OCC path wire shape',
    block_occt_operations_pipe_input_shapes: 'Section shapes',
    block_occt_operations_pipe_description: 'Pipes OCC section shapes along the path wire. Pipe can be created with single or multiple sections.',
    block_occt_shapes_wire_get_wire_input_shape: 'Get wire of OCC shape',
    block_occt_shapes_wire_get_wire_input_index: 'Index',
    block_occt_shapes_wire_get_wire_description: 'Gets the wire of the OCC shape at a given face index. You can enable face index visibility in "draw shape" component.',
    block_occt_shapes_edge_get_edge_input_shape: 'Get edge of OCC shape',
    block_occt_shapes_edge_get_edge_input_index: 'Index',
    block_occt_shapes_edge_get_edge_description: 'Gets the edge of the OCC shape at a given index. You can enable edge index visibility in "draw shape" component.',
    block_occt_shapes_face_get_face_input_shape: 'Get face of OCC shape',
    block_occt_shapes_face_get_face_input_index: 'Index',
    block_occt_shapes_face_get_face_description: 'Gets the face of the OCC shape at a given face index. You can enable face index visibility in "draw shape" component.',
    ...
    block_occt_io_import_step_or_iges_file_input_asset_name: 'Import STEP or IGES file and cache with asset name',
    block_occt_io_import_step_or_iges_file_description: 'Imports STEP or IGES file and stores it in the cache for multiple run cycles with an asset name. To access this object from the cache use a variable or get asset component.',
    block_occt_shapes_compound_make_compound_input_shapes: 'Compound multiple OCC shapes',
    block_occt_shapes_compound_make_compound_description: 'Compounds multiple OCC shapes into a single shape, which can include any kind of OCC shape.',
    block_occt_operations_make_thick_solid_simple_input_shape: 'Thick OCC solid from shape',
    block_occt_operations_make_thick_solid_simple_input_offset: 'Offset',
    block_occt_operations_make_thick_solid_simple_description: 'Makes a simple OCC solid from OCC shape given the offset distance.',
    block_occt_shapes_face_create_face_from_wire_input_wire: 'Face from OCC wire shape',
    block_occt_shapes_face_create_face_from_wire_input_planar: 'Is planar',
    block_occt_shapes_face_create_face_from_wire_description: 'Creates a face from OCC wire shape. If planar is selected will try to make planar face.',
    block_scene_adjust_active_arc_rotate_camera_input_position: 'Adjust arc rotate camera position',
    block_scene_adjust_active_arc_rotate_camera_input_max_z: 'Max Z',
    ...
    block_scene_mesh_instance_and_transform_input_babylon_mesh: 'Create instance and transform the mesh',
    block_scene_mesh_instance_and_transform_input_position: 'Position',
    block_scene_mesh_instance_and_transform_input_rotation: 'Rotation',
    block_scene_mesh_instance_and_transform_input_scaling: 'Scaling',
    block_scene_mesh_instance_and_transform_description: 'Creates BabylonJS instance mesh for optimized rendering and can transform it. This will improve GPU performance and make a scene lighter',
});
