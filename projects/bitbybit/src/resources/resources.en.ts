...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    block_toolbox_category_create_2d_primitive: '2D Primitive',
    block_toolbox_category_create_3d_primitive: '3D Primitive',
    ...
    block_csg_primitive_2d_rectangle_input_center: 'Rectangle on the ground with center point',
    ...
    block_csg_primitive_2d_polygon_input_points: 'Ground polygon from points',
    block_csg_primitive_2d_polygon_description: 'Creates a polygon on the ground, given 2D points',
