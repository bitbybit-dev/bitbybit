...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    block_csg_primitive_2d_polygon_from_points_input_points: 'Polygon from XY points',
    block_csg_primitive_2d_polygon_from_points_description: 'Creates a polygon when given a list of XY points',
    block_csg_primitive_2d_polygon_from_polyline_input_polyline: 'Polygon from XY polyline',
    block_csg_primitive_2d_polygon_from_polyline_description: 'Creates a polygon when given XY polyline',
    block_csg_primitive_2d_polygon_from_curve_input_curve: 'Polygon from XY curve',
    block_csg_primitive_2d_polygon_from_curve_description: 'Creates a polygon when given XY curve',
    block_csg_primitive_2d_polygon_from_path_input_path: 'Polygon from XY path',
    block_csg_primitive_2d_polygon_from_path_description: 'Creates a polygon when given XY path',
    ...
    block_csg_transform_solids_input_solids: 'Transform solids',
    block_csg_transform_solids_input_transformation: 'Transformation',
    block_csg_transform_solids_description: 'Transforms the solids with a transformation',
    block_csg_sphere_input_center: 'Sphere on the center point',
    ...
    block_csg_cube_input_center: 'Cube on the center point',
    ...
    block_csg_subtract_objects_from_solid_input_objects: 'Subtract solids',
    block_csg_subtract_objects_from_solid_input_solid: 'From solid',
    block_csg_subtract_objects_from_solid_description: 'Subtracts the solids from a single solid.',
    ...
    block_csg_cuboid_input_center: 'Cuboid on the center point',
    ...
    block_csg_extrude_rectangular_points_input_points: 'Rectangular extrusion path of XY points',
    block_csg_extrude_rectangular_points_input_height: 'Height',
    block_csg_extrude_rectangular_points_input_size: 'Size',
    block_csg_extrude_rectangular_points_description: 'Creates rectangular extrusion of path formed by XY points.',
    block_csg_extrude_rectangular_path_input_path: 'Rectangular extrusion of XY path',
    ...
    block_csg_extrude_rectangular_paths_input_paths: 'Rectangular extrusion of XY paths',
    ...
    block_csg_primitive_2d_path_from_points_input_points: 'Path from XY points',
    block_csg_primitive_2d_path_from_points_input_closed: 'Closed',
    block_csg_primitive_2d_path_from_points_description: 'Creates a XY path from given points.',
    block_csg_primitive_2d_path_close_input_close: 'Close the XY path',
    block_csg_primitive_2d_path_close_description: 'Closes XY path by joining last point with the first point.',
    ...
    block_csg_primitive_2d_path_append_arc_input_end_point: 'With XY end point',
    block_csg_primitive_2d_path_append_arc_input_radius_x: 'X radius',
    block_csg_primitive_2d_path_append_arc_input_radius_y: 'Y radius',
    ...
    block_csg_primitive_2d_path_from_polyline_input_polyline: 'Path from XY polyline',
    ...
    block_csg_primitive_2d_path_from_curve_input_curve: 'Path from XY curve',
    ...
    block_csg_expansions_expand_paths_input_paths: 'Expand to polygons the paths',
    block_csg_expansions_expand_paths_input_delta: 'Delta',
    block_csg_expansions_expand_paths_input_corners: 'Corner type',
    block_csg_expansions_expand_paths_input_segments: 'Segment count',
    block_csg_expansions_expand_paths_description: 'Expands the paths to polygons with given delta distance, selected corner type and segment count.',
    block_csg_expansions_expand_polygons_input_polygons: 'Expand polygons',
    block_csg_expansions_expand_polygons_input_delta: 'Delta',
    block_csg_expansions_expand_polygons_input_corners: 'Corners',
    block_csg_expansions_expand_polygons_input_segments: 'Segment count',
    block_csg_expansions_expand_polygons_description: 'Expands the polygons with given delta distance, selected corner type and segment count.',
    block_csg_expansions_expand_solids_input_solids: 'Expand solids',
    block_csg_expansions_expand_solids_input_delta: 'Delta',
    block_csg_expansions_expand_solids_input_corners: 'Corners',
    block_csg_expansions_expand_solids_input_segments: 'Segment count',
    block_csg_expansions_expand_solids_description: 'Expands the solids with given delta distance, selected corner type and segment count.',
    block_csg_expansions_offset_path_input_delta: 'Delta',
    block_csg_expansions_offset_path_input_path: 'Offset to polygon the path',
    block_csg_expansions_offset_path_input_corners: 'Corner type',
    block_csg_expansions_offset_path_input_segments: 'Segment count',
    block_csg_expansions_offset_path_description: 'Offsets the path to polygon with given delta distance, selected corner type and segment count.',
    block_csg_expansions_offset_polygon_input_polygon: 'Offset polygon',
    block_csg_expansions_offset_polygon_input_delta: 'Delta',
    block_csg_expansions_offset_polygon_input_corners: 'Corners',
    block_csg_expansions_offset_polygon_input_segments: 'Segment count',
    block_csg_expansions_offset_polygon_description: 'Offsets the polygon with given delta distance, selected corner type and segment count.',
    block_csg_expansions_offset_solid_description: 'Offsets the solid with given delta distance, selected corner type and segment count.',
    block_csg_expansions_offset_paths_input_paths: 'Offset to polygons the paths',
    block_csg_expansions_offset_paths_input_delta: 'Delta',
    block_csg_expansions_offset_paths_input_corners: 'Corner type',
    block_csg_expansions_offset_paths_input_segments: 'Segment count',
    block_csg_expansions_offset_paths_description: 'Offsets the paths to polygons with given delta distance, selected corner type and segment count.',
    block_csg_expansions_offset_polygons_input_polygons: 'Offset polygons',
    ...
    block_csg_cylinder_input_center: 'Cylinder on the center point',
    ...
    block_csg_spheres_on_center_points_input_centers: 'Spheres on the center points',
    block_csg_spheres_on_center_points_input_radius: 'Radius',
    block_csg_spheres_on_center_points_input_segments: 'Segment count',
    block_csg_spheres_on_center_points_description: 'Creates a list of spheres on the center points of given radius and segment count.',
    block_csg_cylinder_on_center_points_input_centers: 'Cylinders on the center points',
    ...
    block_csg_cylinder_on_center_points_description: 'Creates cylinders of given radius, height and segments on the center points.',
    block_csg_cuboids_on_center_points_input_centers: 'Cuboids on the center points',
    ...
    block_csg_cubes_on_center_points_input_centers: 'Cubes on the center points',
    block_csg_cubes_on_center_points_input_size: 'Size',
    block_csg_cubes_on_center_points_description: 'Create a list of cubes on the center points.',
    block_csg_primitive_2d_ellipse_input_center: 'Ellipse on the center point',
    block_csg_primitive_2d_ellipse_input_radius: 'Radius XY',
    block_csg_primitive_2d_ellipse_input_segments: 'Segment count',
    block_csg_primitive_2d_ellipse_description: 'Creates given size ellipse on the center point.',
    block_csg_cylinder_elliptic_input_center: 'Elliptic cylinder on the center point',
    block_csg_cylinder_elliptic_input_start_radius: 'Start radius XY',
    block_csg_cylinder_elliptic_input_end_radius: 'End radius XY',
    ...
    block_csg_cylinders_elliptic_on_center_points_input_centers: 'Elliptic cylinders on the center points',
    block_csg_cylinders_elliptic_on_center_points_input_start_radius: 'Start radius XY',
    block_csg_cylinders_elliptic_on_center_points_input_end_radius: 'End radius XY',
    ...
    block_csg_cylinders_elliptic_on_center_points_description: 'Creates elliptic cylinders on the center points with start and end radius, height and segment count.',
    block_csg_ellipsoid_input_center: 'Ellipsoid on the center point',
    ...
    block_csg_ellipsoid_description: 'Creates ellipsoid on the center point of given radius and segment count.',
    block_csg_ellipsoids_on_center_points_input_centers: 'Ellipsoids on the center points',
    ...
    block_csg_ellipsoids_on_center_points_description: 'Creates ellipsoids on the center points of the given radius and segment count.',
    ...
    block_csg_geodesic_spheres_on_center_points_input_centers: 'Geodesic spheres on the center points',
    ...
    block_csg_geodesic_spheres_on_center_points_description: 'Creates geodesic spheres on the center points with given radius and frequency.',
    block_csg_rounded_cuboid_input_center: 'Rounded cuboid on the center point',
    block_csg_rounded_cuboid_input_width: 'Width',
    block_csg_rounded_cuboid_input_length: 'Length',
    block_csg_rounded_cuboid_input_height: 'Height',
    ...
    block_csg_rounded_cuboids_on_center_points_input_centers: 'Rounded cuboids on the center points',
    ...
    block_csg_rounded_cylinder_input_center: 'Rounded cylinder on the center point',
    block_csg_rounded_cylinder_input_round_radius: 'Round radius',
    ...
    block_csg_primitive_2d_rounded_rectangle_input_center: 'Rounded rectangle on the center point',
    block_csg_primitive_2d_rounded_rectangle_input_width: 'Width',
    block_csg_primitive_2d_rounded_rectangle_input_length: 'Length',
    ...
    block_csg_primitive_2d_star_input_center: 'Star on the center point',
    block_csg_primitive_2d_star_input_outer_radius: 'Outer radius',
    block_csg_primitive_2d_star_input_inner_radius: 'Inner radius',
    block_csg_primitive_2d_star_input_vertices: 'Vertices',
    block_csg_primitive_2d_star_input_density: 'Density',
    block_csg_primitive_2d_star_input_start_angle: 'Start angle',
    block_csg_primitive_2d_star_description: 'Creates a star polygon on the given center point.',
    block_csg_torus_input_center: 'Torus on the center point',
    block_csg_torus_input_inner_radius: 'Inner radius',
    block_csg_torus_input_outer_radius: 'Outer radius',
    block_csg_torus_input_inner_segments: 'Inner segment count',
    block_csg_torus_input_outer_segments: 'Outer segment count',
    block_csg_torus_input_inner_rotation: 'Inner rotation',
    block_csg_torus_input_outer_rotation: 'Outer rotation',
    block_csg_torus_input_start_angle: 'Start angle',
    block_csg_torus_description: 'Creates a torus of given parameters on the center point.',
    block_csg_text_vector_cylindrical_text_input_input: 'Cylindric text',
    block_csg_text_vector_cylindrical_text_input_extrude_height: 'Extrusion height',
    block_csg_text_vector_cylindrical_text_input_extrude_size: 'Extrusion size',
    block_csg_text_vector_cylindrical_text_input_segments: 'Segment count',
    block_csg_text_vector_cylindrical_text_input_x_offset: 'X offset',
    block_csg_text_vector_cylindrical_text_input_y_offset: 'Y offset',
    block_csg_text_vector_cylindrical_text_input_height: 'Height',
    block_csg_text_vector_cylindrical_text_input_line_spacing: 'Line spacing',
    block_csg_text_vector_cylindrical_text_input_letter_spacing: 'Letter spacing',
    block_csg_text_vector_cylindrical_text_input_align: 'Align',
    block_csg_text_vector_cylindrical_text_input_extrude_offset: 'Extrude offset',
    block_csg_text_vector_cylindrical_text_description: 'Creates a rectangular extrusion of the text.',
    block_csg_text_vector_spherical_text_input_input: 'Spherical text',
    block_csg_text_vector_spherical_text_input_radius: 'Radius',
    block_csg_text_vector_spherical_text_input_segments: 'Segment count',
    block_csg_text_vector_spherical_text_input_x_offset: 'X offset',
    block_csg_text_vector_spherical_text_input_y_offset: 'Y offset',
    block_csg_text_vector_spherical_text_input_height: 'Height',
    block_csg_text_vector_spherical_text_input_line_spacing: 'Line spacing',
    block_csg_text_vector_spherical_text_input_letter_spacing: 'Letter spacing',
    block_csg_text_vector_spherical_text_input_align: 'Align',
    block_csg_text_vector_spherical_text_input_extrude_offset: 'Extrude offset',
