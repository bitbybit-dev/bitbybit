...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    block_toolbox_category_geom_mesh: 'Mesh',
    ...
    block_babylon_draw_csg_mesh_input_csg_mesh_2: 'with solid',
    block_babylon_draw_csg_mesh_description: 'Draws the solid mesh',
    block_babylon_draw_csg_polygon_input_csg_polygon_variable: 'polygonMesh',
    block_babylon_draw_csg_polygon_input_csg_polygon: 'Draw',
    block_babylon_draw_csg_polygon_input_csg_polygon_2: 'with polygon',
    block_babylon_draw_csg_polygon_description: 'Draws the polygon',
    ...
    block_csg_rectangle_input_center: 'Rectangle on the ground with center point',
    block_csg_rectangle_input_width: 'Width',
    block_csg_rectangle_input_length: 'Length',
    block_csg_rectangle_description: 'Creates a rectangle polygon on the center point of given dimensions.',
    block_csg_extrude_linear_input_polygon: 'Solid from linear extrude of polygon',
    block_csg_extrude_linear_input_height: 'Height',
    block_csg_extrude_linear_input_twist_angle: 'Twist angle',
    block_csg_extrude_linear_input_twist_steps: 'Twist steps',
    block_csg_extrude_linear_description: 'Exrudes linearly the polygon into the given height, twist angle and steps.',
    block_csg_polygon_input_points: 'Ground polygon from points',
    block_csg_polygon_description: 'Creates a polygon on the ground, given 2D points',
    block_csg_transform_input_csg_mesh: 'Transform solid mesh',
    ...
    block_csg_union_input_union_object: 'Union object',
    block_csg_union_input_with_object: 'With object',
    block_csg_union_description: 'Union two objects together.',
    block_csg_intersect_input_intersect_object: 'Intersect solid',
    block_csg_intersect_input_with_object: 'With solid',
    block_csg_intersect_description: 'Intersects two objects and returns the result.',
});
