...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    block_babylon_draw_csg_mesh_input_csg_mesh_2: 'with solid mesh',
    ...
    block_babylon_input_draw_nodes_description: 'Draws the xyz axis of multiple nodes.',
    ...
    block_babylon_node_get_rotation_description: 'Gets nodes\' rotation vector in degrees for rotation around x, y and z axis.'
});
