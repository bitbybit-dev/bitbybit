...
export const resourcesEn: ResourcesInterface = Object.freeze({
    ...
    block_csg_primitive_2d_ellipse_input_radius: 'Radius XZ',
    ...
    block_csg_cylinder_elliptic_input_start_radius: 'Start radius XZ',
    block_csg_cylinder_elliptic_input_end_radius: 'End radius XZ',
