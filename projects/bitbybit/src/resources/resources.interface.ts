export interface ResourcesInterface {
    ...
    app_menu_more_examples_street_smart_parametric_lamp_description: string;
    app_menu_more_examples_street_smart_parametric_vase_title: string;
    ...
    app_button_save_and_continue: string;
    app_button_continue: string;
    app_button_cancel: string;
    app_button_create: string;
    app_preferred_editor: string;
    app_languages: string;
    app_languages_lithuanian: string;
    app_languages_english: string;
    app_editors_visual: string;
    app_editors_textual: string;
    ...
    block_toolbox_category_3d_text: string;
    ...
    block_toolbox_category_apply_transform: string;
    ...
    block_toolbox_category_occ_wire: string;
    block_toolbox_category_occ_face: string;
    block_toolbox_category_occ_apply: string;
    block_toolbox_category_occ_operation: string;
    block_toolbox_category_occ_boolean: string;
    block_toolbox_category_occ_transform: string;
    block_toolbox_category_occ_shapes: string;
    block_toolbox_category_occ_edge: string;
    ...
    block_shape: string;
    block_holes: string;
    block_x_offset: string;
    block_y_offset: string;
    block_z_offset: string;
    block_extrude_offset: string;
    block_input_text: string;
    block_radius: string;
    ...
    block_line_spacing: string;
    block_letter_spacing: string;
    block_align: string;
    ...
    block_jscad_primitive_2d_rectangle_input_center: string;
    block_jscad_primitive_2d_rectangle_input_width: string;
    block_jscad_primitive_2d_rectangle_input_length: string;
    block_jscad_primitive_2d_rectangle_description: string;
    block_jscad_extrude_linear_polygon_input_polygon: string;
    block_jscad_extrude_linear_polygon_input_height: string;
    block_jscad_extrude_linear_polygon_input_twist_angle: string;
    block_jscad_extrude_linear_polygon_input_twist_steps: string;
    block_jscad_extrude_linear_polygon_description: string;
    block_jscad_extrude_linear_polygon_objects_input_polygons: string;
    block_jscad_extrude_linear_polygon_objects_input_height: string;
    block_jscad_extrude_linear_polygon_objects_input_twist_angle: string;
    block_jscad_extrude_linear_polygon_objects_input_twist_steps: string;
    block_jscad_extrude_linear_polygon_objects_description: string;
    block_jscad_primitive_2d_polygon_from_points_input_points: string;
    block_jscad_primitive_2d_polygon_from_points_description: string;
    block_jscad_primitive_2d_polygon_from_polyline_input_polyline: string;
    block_jscad_primitive_2d_polygon_from_polyline_description: string;
    block_jscad_primitive_2d_polygon_from_curve_input_curve: string;
    block_jscad_primitive_2d_polygon_from_curve_description: string;
    block_jscad_primitive_2d_polygon_from_path_input_path: string;
    block_jscad_primitive_2d_polygon_from_path_description: string;
    block_jscad_transform_input_csg_mesh: string;
    block_jscad_transform_input_transformation: string;
    block_jscad_transform_description: string;
    block_jscad_transform_solids_input_solids: string;
    block_jscad_transform_solids_input_transformation: string;
    block_jscad_transform_solids_description: string;
    block_jscad_sphere_input_center: string;
    block_jscad_sphere_input_radius: string;
    block_jscad_sphere_input_segments: string;
    block_jscad_sphere_description: string;
    block_jscad_cube_input_center: string;
    block_jscad_cube_input_size: string;
    block_jscad_cube_description: string;
    block_jscad_subtract_input_subtract_from_object: string;
    block_jscad_subtract_input_subtract_object: string;
    block_jscad_subtract_description: string;
    block_jscad_union_input_union_object: string;
    block_jscad_union_input_with_object: string;
    block_jscad_union_description: string;
    block_jscad_intersect_input_intersect_object: string;
    block_jscad_intersect_input_with_object: string;
    block_jscad_intersect_description: string;
    block_jscad_color_input_color: string;
    block_jscad_color_input_object: string;
    block_jscad_color_description: string;
    block_jscad_cuboid_input_center: string;
    block_jscad_cuboid_input_width: string;
    block_jscad_cuboid_input_length: string;
    block_jscad_cuboid_input_height: string;
    block_jscad_cuboid_description: string;
    block_jscad_union_objects_input_objects: string;
    block_jscad_union_objects_description: string;
    block_jscad_subtract_objects_input_objects: string;
    block_jscad_subtract_objects_description: string;
    block_jscad_subtract_objects_from_solid_input_objects: string;
    block_jscad_subtract_objects_from_solid_input_solid: string;
    block_jscad_subtract_objects_from_solid_description: string;
    block_jscad_intersect_objects_input_objects: string;
    block_jscad_intersect_objects_description: string;
    block_jscad_extrude_rectangular_points_input_points: string;
    block_jscad_extrude_rectangular_points_input_height: string;
    block_jscad_extrude_rectangular_points_input_size: string;
    block_jscad_extrude_rectangular_points_description: string;
    block_jscad_extrude_rectangular_path_input_path: string;
    block_jscad_extrude_rectangular_path_input_height: string;
    block_jscad_extrude_rectangular_path_input_size: string;
    block_jscad_extrude_rectangular_path_description: string;
    block_jscad_extrude_rectangular_paths_input_paths: string;
    block_jscad_extrude_rectangular_paths_input_height: string;
    block_jscad_extrude_rectangular_paths_input_size: string;
    block_jscad_extrude_rectangular_paths_description: string;
    block_jscad_primitive_2d_path_from_points_input_points: string;
    block_jscad_primitive_2d_path_from_points_input_closed: string;
    block_jscad_primitive_2d_path_from_points_description: string;
    block_jscad_primitive_2d_path_close_input_close: string;
    block_jscad_primitive_2d_path_close_description: string;
    block_jscad_primitive_2d_path_append_points_input_path: string;
    block_jscad_primitive_2d_path_append_points_input_points: string;
    block_jscad_primitive_2d_path_append_points_description: string;
    block_jscad_primitive_2d_path_append_arc_input_path: string;
    block_jscad_primitive_2d_path_append_arc_input_end_point: string;
    block_jscad_primitive_2d_path_append_arc_input_radius_x: string;
    block_jscad_primitive_2d_path_append_arc_input_radius_y: string;
    block_jscad_primitive_2d_path_append_arc_input_x_axis_rotation: string;
    block_jscad_primitive_2d_path_append_arc_input_clockwise: string;
    block_jscad_primitive_2d_path_append_arc_input_large: string;
    block_jscad_primitive_2d_path_append_arc_input_segments: string;
    block_jscad_primitive_2d_path_append_arc_description: string;
    block_jscad_primitive_2d_path_append_polyline_input_path: string;
    block_jscad_primitive_2d_path_append_polyline_input_polyline: string;
    block_jscad_primitive_2d_path_append_polyline_description: string;
    block_jscad_primitive_2d_path_append_curve_input_path: string;
    block_jscad_primitive_2d_path_append_curve_input_curve: string;
    block_jscad_primitive_2d_path_append_curve_description: string;
    block_jscad_primitive_2d_path_empty_input_path: string;
    block_jscad_primitive_2d_path_empty_description: string;
    block_jscad_primitive_2d_path_from_polyline_input_polyline: string;
    block_jscad_primitive_2d_path_from_polyline_input_closed: string;
    block_jscad_primitive_2d_path_from_polyline_description: string;
    block_jscad_primitive_2d_path_from_curve_input_curve: string;
    block_jscad_primitive_2d_path_from_curve_input_closed: string;
    block_jscad_primitive_2d_path_from_curve_description: string;
    block_jscad_extrude_rotate_polygon_input_polygon: string;
    block_jscad_extrude_rotate_polygon_input_angle: string;
    block_jscad_extrude_rotate_polygon_input_start_angle: string;
    block_jscad_extrude_rotate_polygon_input_segments: string;
    block_jscad_extrude_rotate_polygon_description: string;
    block_jscad_hull_paths_input_paths: string;
    block_jscad_hull_paths_description: string;
    block_jscad_hull_polygons_input_polygons: string;
    block_jscad_hull_polygons_description: string;
    block_jscad_hull_solids_input_solids: string;
    block_jscad_hull_solids_description: string;
    block_jscad_chain_hull_paths_input_paths: string;
    block_jscad_chain_hull_paths_description: string;
    block_jscad_chain_hull_polygons_input_polygons: string;
    block_jscad_chain_hull_polygons_description: string;
    block_jscad_chain_hull_solids_input_solids: string;
    block_jscad_chain_hull_solids_description: string;
    block_jscad_corner_type_input_round: string;
    block_jscad_corner_type_input_chamfer: string;
    block_jscad_corner_type_input_edge: string;
    block_jscad_expansions_expand_path_input_path: string;
    block_jscad_expansions_expand_path_input_delta: string;
    block_jscad_expansions_expand_path_input_corners: string;
    block_jscad_expansions_expand_path_input_segments: string;
    block_jscad_expansions_expand_path_description: string;
    block_jscad_expansions_expand_polygon_input_polygon: string;
    block_jscad_expansions_expand_polygon_input_delta: string;
    block_jscad_expansions_expand_polygon_input_corners: string;
    block_jscad_expansions_expand_polygon_input_segments: string;
    block_jscad_expansions_expand_polygon_description: string;
    block_jscad_expansions_expand_solid_input_solid: string;
    block_jscad_expansions_expand_solid_input_delta: string;
    block_jscad_expansions_expand_solid_input_corners: string;
    block_jscad_expansions_expand_solid_input_segments: string;
    block_jscad_expansions_expand_solid_description: string;
    block_jscad_expansions_expand_paths_input_paths: string;
    block_jscad_expansions_expand_paths_input_delta: string;
    block_jscad_expansions_expand_paths_input_corners: string;
    block_jscad_expansions_expand_paths_input_segments: string;
    block_jscad_expansions_expand_paths_description: string;
    block_jscad_expansions_expand_polygons_input_polygons: string;
    block_jscad_expansions_expand_polygons_input_delta: string;
    block_jscad_expansions_expand_polygons_input_corners: string;
    block_jscad_expansions_expand_polygons_input_segments: string;
    block_jscad_expansions_expand_polygons_description: string;
    block_jscad_expansions_expand_solids_input_solids: string;
    block_jscad_expansions_expand_solids_input_delta: string;
    block_jscad_expansions_expand_solids_input_corners: string;
    block_jscad_expansions_expand_solids_input_segments: string;
    block_jscad_expansions_expand_solids_description: string;
    block_jscad_expansions_offset_path_input_path: string;
    block_jscad_expansions_offset_path_input_delta: string;
    block_jscad_expansions_offset_path_input_corners: string;
    block_jscad_expansions_offset_path_input_segments: string;
    block_jscad_expansions_offset_path_description: string;
    block_jscad_expansions_offset_polygon_input_polygon: string;
    block_jscad_expansions_offset_polygon_input_delta: string;
    block_jscad_expansions_offset_polygon_input_corners: string;
    block_jscad_expansions_offset_polygon_input_segments: string;
    block_jscad_expansions_offset_polygon_description: string;
    block_jscad_expansions_offset_paths_input_paths: string;
    block_jscad_expansions_offset_paths_input_delta: string;
    block_jscad_expansions_offset_paths_input_corners: string;
    block_jscad_expansions_offset_paths_input_segments: string;
    block_jscad_expansions_offset_paths_description: string;
    block_jscad_expansions_offset_polygons_input_polygons: string;
    block_jscad_expansions_offset_polygons_input_delta: string;
    block_jscad_expansions_offset_polygons_input_corners: string;
    block_jscad_expansions_offset_polygons_input_segments: string;
    block_jscad_expansions_offset_polygons_description: string;
    block_jscad_primitive_2d_circle_input_center: string;
    block_jscad_primitive_2d_circle_input_radius: string;
    block_jscad_primitive_2d_circle_input_segments: string;
    block_jscad_primitive_2d_circle_description: string;
    block_jscad_cylinder_input_center: string;
    block_jscad_cylinder_input_radius: string;
    block_jscad_cylinder_input_height: string;
    block_jscad_cylinder_input_segments: string;
    block_jscad_cylinder_description: string;
    block_jscad_spheres_on_center_points_input_centers: string;
    block_jscad_spheres_on_center_points_input_radius: string;
    block_jscad_spheres_on_center_points_input_segments: string;
    block_jscad_spheres_on_center_points_description: string;
    block_jscad_cylinder_on_center_points_input_centers: string;
    block_jscad_cylinder_on_center_points_input_radius: string;
    block_jscad_cylinder_on_center_points_input_height: string;
    block_jscad_cylinder_on_center_points_input_segments: string;
    block_jscad_cylinder_on_center_points_description: string;
    block_jscad_cuboids_on_center_points_input_centers: string;
    block_jscad_cuboids_on_center_points_input_width: string;
    block_jscad_cuboids_on_center_points_input_length: string;
    block_jscad_cuboids_on_center_points_input_height: string;
    block_jscad_cuboids_on_center_points_description: string;
    block_jscad_cubes_on_center_points_input_centers: string;
    block_jscad_cubes_on_center_points_input_size: string;
    block_jscad_cubes_on_center_points_description: string;
    block_jscad_primitive_2d_ellipse_input_center: string;
    block_jscad_primitive_2d_ellipse_input_radius: string;
    block_jscad_primitive_2d_ellipse_input_segments: string;
    block_jscad_primitive_2d_ellipse_description: string;
    block_jscad_cylinder_elliptic_input_center: string;
    block_jscad_cylinder_elliptic_input_start_radius: string;
    block_jscad_cylinder_elliptic_input_end_radius: string;
    block_jscad_cylinder_elliptic_input_height: string;
    block_jscad_cylinder_elliptic_input_segments: string;
    block_jscad_cylinder_elliptic_description: string;
    block_jscad_cylinders_elliptic_on_center_points_input_centers: string;
    block_jscad_cylinders_elliptic_on_center_points_input_start_radius: string;
    block_jscad_cylinders_elliptic_on_center_points_input_end_radius: string;
    block_jscad_cylinders_elliptic_on_center_points_input_height: string;
    block_jscad_cylinders_elliptic_on_center_points_input_segments: string;
    block_jscad_cylinders_elliptic_on_center_points_description: string;
    block_jscad_ellipsoid_input_center: string;
    block_jscad_ellipsoid_input_radius: string;
    block_jscad_ellipsoid_input_segments: string;
    block_jscad_ellipsoid_input_axis_x: string;
    block_jscad_ellipsoid_input_axis_y: string;
    block_jscad_ellipsoid_input_axis_z: string;
    block_jscad_ellipsoid_description: string;
    block_jscad_ellipsoids_on_center_points_input_centers: string;
    block_jscad_ellipsoids_on_center_points_input_radius: string;
    block_jscad_ellipsoids_on_center_points_input_segments: string;
    block_jscad_ellipsoids_on_center_points_description: string;
    block_jscad_geodesic_sphere_input_center: string;
    block_jscad_geodesic_sphere_input_radius: string;
    block_jscad_geodesic_sphere_input_frequency: string;
    block_jscad_geodesic_sphere_description: string;
    block_jscad_geodesic_spheres_on_center_points_input_centers: string;
    block_jscad_geodesic_spheres_on_center_points_input_radius: string;
    block_jscad_geodesic_spheres_on_center_points_input_frequency: string;
    block_jscad_geodesic_spheres_on_center_points_description: string;
    block_jscad_rounded_cuboid_input_center: string;
    block_jscad_rounded_cuboid_input_width: string;
    block_jscad_rounded_cuboid_input_length: string;
    block_jscad_rounded_cuboid_input_height: string;
    block_jscad_rounded_cuboid_input_round_radius: string;
    block_jscad_rounded_cuboid_input_segments: string;
    block_jscad_rounded_cuboid_description: string;
    block_jscad_rounded_cuboids_on_center_points_input_centers: string;
    block_jscad_rounded_cuboids_on_center_points_input_width: string;
    block_jscad_rounded_cuboids_on_center_points_input_length: string;
    block_jscad_rounded_cuboids_on_center_points_input_height: string;
    block_jscad_rounded_cuboids_on_center_points_input_round_radius: string;
    block_jscad_rounded_cuboids_on_center_points_input_segments: string;
    block_jscad_rounded_cuboids_on_center_points_description: string;
    block_jscad_rounded_cylinder_input_center: string;
    block_jscad_rounded_cylinder_input_radius: string;
    block_jscad_rounded_cylinder_input_round_radius: string;
    block_jscad_rounded_cylinder_input_height: string;
    block_jscad_rounded_cylinder_input_segments: string;
    block_jscad_rounded_cylinder_description: string;
    block_jscad_rounded_cylinders_on_center_points_input_centers: string;
    block_jscad_rounded_cylinders_on_center_points_input_radius: string;
    block_jscad_rounded_cylinders_on_center_points_input_round_radius: string;
    block_jscad_rounded_cylinders_on_center_points_input_height: string;
    block_jscad_rounded_cylinders_on_center_points_input_segments: string;
    block_jscad_rounded_cylinders_on_center_points_description: string;
    block_jscad_primitive_2d_rounded_rectangle_input_center: string;
    block_jscad_primitive_2d_rounded_rectangle_input_width: string;
    block_jscad_primitive_2d_rounded_rectangle_input_length: string;
    block_jscad_primitive_2d_rounded_rectangle_input_round_radius: string;
    block_jscad_primitive_2d_rounded_rectangle_input_segments: string;
    block_jscad_primitive_2d_rounded_rectangle_description: string;
    block_jscad_primitive_2d_square_input_center: string;
    block_jscad_primitive_2d_square_input_size: string;
    block_jscad_primitive_2d_square_description: string;
    block_jscad_primitive_2d_star_input_center: string;
    block_jscad_primitive_2d_star_input_outer_radius: string;
    block_jscad_primitive_2d_star_input_inner_radius: string;
    block_jscad_primitive_2d_star_input_vertices: string;
    block_jscad_primitive_2d_star_input_density: string;
    block_jscad_primitive_2d_star_input_start_angle: string;
    block_jscad_primitive_2d_star_description: string;
    block_jscad_torus_input_center: string;
    block_jscad_torus_input_inner_radius: string;
    block_jscad_torus_input_outer_radius: string;
    block_jscad_torus_input_inner_segments: string;
    block_jscad_torus_input_outer_segments: string;
    block_jscad_torus_input_inner_rotation: string;
    block_jscad_torus_input_outer_rotation: string;
    block_jscad_torus_input_start_angle: string;
    block_jscad_torus_description: string;
    block_jscad_text_vector_cylindrical_text_input_input: string;
    block_jscad_text_vector_cylindrical_text_input_extrude_height: string;
    block_jscad_text_vector_cylindrical_text_input_extrude_size: string;
    block_jscad_text_vector_cylindrical_text_input_segments: string;
    block_jscad_text_vector_cylindrical_text_input_x_offset: string;
    block_jscad_text_vector_cylindrical_text_input_y_offset: string;
    block_jscad_text_vector_cylindrical_text_input_height: string;
    block_jscad_text_vector_cylindrical_text_input_line_spacing: string;
    block_jscad_text_vector_cylindrical_text_input_letter_spacing: string;
    block_jscad_text_vector_cylindrical_text_input_align: string;
    block_jscad_text_vector_cylindrical_text_input_extrude_offset: string;
    block_jscad_text_vector_cylindrical_text_description: string;
    block_jscad_text_vector_spherical_text_input_input: string;
    block_jscad_text_vector_spherical_text_input_radius: string;
    block_jscad_text_vector_spherical_text_input_segments: string;
    block_jscad_text_vector_spherical_text_input_x_offset: string;
    block_jscad_text_vector_spherical_text_input_y_offset: string;
    block_jscad_text_vector_spherical_text_input_height: string;
    block_jscad_text_vector_spherical_text_input_line_spacing: string;
    block_jscad_text_vector_spherical_text_input_letter_spacing: string;
    block_jscad_text_vector_spherical_text_input_align: string;
    block_jscad_text_vector_spherical_text_input_extrude_offset: string;
    block_jscad_text_vector_spherical_text_description: string;
    block_jscad_text_align_type_input_left: string;
    block_jscad_text_align_type_input_center: string;
    block_jscad_text_align_type_input_right: string;
    block_jscad_io_solid_to_stl_input_solid: string;
    block_jscad_io_solid_to_stl_input_file_name: string;
    block_jscad_io_solid_to_stl_description: string;
    block_jscad_io_solids_to_stl_input_solids: string;
    block_jscad_io_solids_to_stl_input_file_name: string;
    block_jscad_io_solids_to_stl_description: string;
    block_occt_draw_shape_input_shape: string;
    block_occt_draw_shape_input_precision: string;
    block_occt_draw_shape_input_draw_faces: string;
    block_occt_draw_shape_input_face_opacity: string;
    block_occt_draw_shape_input_face_colour: string;
    block_occt_draw_shape_input_draw_face_indexes: string;
    block_occt_draw_shape_input_face_index_height: string;
    block_occt_draw_shape_input_face_index_colour: string;
    block_occt_draw_shape_input_draw_edges: string;
    block_occt_draw_shape_input_edge_opacity: string;
    block_occt_draw_shape_input_edge_colour: string;
    block_occt_draw_shape_input_edge_width: string;
    block_occt_draw_shape_input_draw_edge_indexes: string;
    block_occt_draw_shape_input_edge_index_height: string;
    block_occt_draw_shape_input_edge_index_colour: string;
    block_occt_draw_shape_description: string;
    block_occt_shapes_solid_create_box_input_width: string;
    block_occt_shapes_solid_create_box_input_length: string;
    block_occt_shapes_solid_create_box_input_height: string;
    block_occt_shapes_solid_create_box_input_center: string;
    block_occt_shapes_solid_create_box_description: string;
    block_occt_shapes_solid_create_sphere_input_radius: string;
    block_occt_shapes_solid_create_sphere_input_center: string;
    block_occt_shapes_solid_create_sphere_description: string;
    block_occt_shapes_solid_create_cone_input_radius_one: string;
    block_occt_shapes_solid_create_cone_input_radius_two: string;
    block_occt_shapes_solid_create_cone_input_height: string;
    block_occt_shapes_solid_create_cone_description: string;
    block_occt_shapes_solid_create_cylinder_input_radius: string;
    block_occt_shapes_solid_create_cylinder_input_height: string;
    block_occt_shapes_solid_create_cylinder_input_center: string;
    block_occt_shapes_solid_create_cylinder_description: string;
    block_occt_shapes_wire_create_bspline_input_points: string;
    block_occt_shapes_wire_create_bspline_input_closed: string;
    block_occt_shapes_wire_create_bspline_description: string;
    block_occt_shapes_wire_create_bezier_input_points: string;
    block_occt_shapes_wire_create_bezier_input_closed: string;
    block_occt_shapes_wire_create_bezier_description: string;
    block_occt_shapes_wire_create_circle_input_radius: string;
    block_occt_shapes_wire_create_circle_input_center: string;
    block_occt_shapes_wire_create_circle_description: string;
    block_occt_shapes_face_create_circle_face_input_radius: string;
    block_occt_shapes_face_create_circle_face_input_center: string;
    block_occt_shapes_face_create_circle_face_description: string;
    block_occt_operations_offset_input_shape: string;
    block_occt_operations_offset_input_distance: string;
    block_occt_operations_offset_input_tolerance: string;
    block_occt_operations_offset_description: string;
    block_occt_operations_extrude_input_shape: string;
    block_occt_operations_extrude_input_direction: string;
    block_occt_operations_extrude_description: string;
    block_occt_operations_loft_input_shapes: string;
    block_occt_operations_loft_input_make_solid: string;
    block_occt_operations_loft_description: string;
    block_occt_operations_revolve_input_shape: string;
    block_occt_operations_revolve_input_angle: string;
    block_occt_operations_revolve_input_direction: string;
    block_occt_operations_revolve_input_copy: string;
    block_occt_operations_revolve_description: string;
    ...
    block_occt_shapes_edge_chamfer_edges_input_shape: string;
    block_occt_shapes_edge_chamfer_edges_input_distance: string;
    block_occt_shapes_edge_chamfer_edges_input_edge_list: string;
    block_occt_shapes_edge_chamfer_edges_description: string;
    block_occt_booleans_union_input_shapes: string;
    block_occt_booleans_union_input_keep_edges: string;
    block_occt_booleans_union_description: string;
    block_occt_booleans_difference_input_shape: string;
    block_occt_booleans_difference_input_shapes: string;
    block_occt_booleans_difference_input_keep_edges: string;
    block_occt_booleans_difference_description: string;
    block_occt_booleans_intersection_input_shapes: string;
    block_occt_booleans_intersection_input_keep_edges: string;
    block_occt_booleans_intersection_description: string;
    block_occt_shapes_wire_create_polygon_input_points: string;
    block_occt_shapes_wire_create_polygon_description: string;
    block_occt_shapes_face_create_polygon_input_points: string;
    block_occt_shapes_face_create_polygon_description: string;
    ...
    block_occt_operations_rotated_extrude_input_shape: string;
    block_occt_operations_rotated_extrude_input_height: string;
    block_occt_operations_rotated_extrude_input_angle: string;
    block_occt_operations_rotated_extrude_description: string;
    block_occt_operations_pipe_input_shape: string;
    block_occt_operations_pipe_input_shapes: string;
    block_occt_operations_pipe_description: string;
    block_occt_shapes_wire_get_wire_input_shape: string;
    block_occt_shapes_wire_get_wire_input_index: string;
    block_occt_shapes_wire_get_wire_description: string;
    block_occt_shapes_edge_get_edge_input_shape: string;
    block_occt_shapes_edge_get_edge_input_index: string;
    block_occt_shapes_edge_get_edge_description: string;
    block_occt_shapes_face_get_face_input_shape: string;
    block_occt_shapes_face_get_face_input_index: string;
    block_occt_shapes_face_get_face_description: string;
    ...
    block_occt_io_import_step_or_iges_file_input_asset_name: string;
    block_occt_io_import_step_or_iges_file_description: string;
    block_occt_shapes_compound_make_compound_input_shapes: string;
    block_occt_shapes_compound_make_compound_description: string;
    block_occt_operations_make_thick_solid_simple_input_shape: string;
    block_occt_operations_make_thick_solid_simple_input_offset: string;
    block_occt_operations_make_thick_solid_simple_description: string;
    block_occt_shapes_face_create_face_from_wire_input_wire: string;
    block_occt_shapes_face_create_face_from_wire_input_planar: string;
    block_occt_shapes_face_create_face_from_wire_description: string;
