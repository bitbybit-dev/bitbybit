...
export class SettingsService {
    ...
    private setToolboxTexts(resources: ResourcesInterface) {
        ...
        const toolboxCategoryFlatList = [
            ...
            resources.block_toolbox_category_create,
            resources.block_toolbox_category_create_2d_path,
            resources.block_toolbox_category_create_2d_polygon,
            resources.block_toolbox_category_create_3d_solid,
            resources.block_toolbox_category_create_extrusion,
            resources.block_toolbox_category_apply,
