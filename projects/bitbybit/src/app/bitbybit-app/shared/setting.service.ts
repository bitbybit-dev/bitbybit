...
export class SettingsService {
    ...
    private setToolboxTexts(resources: ResourcesInterface) {
        ...
        const toolboxCategoryFlatList = [
            ...
            resources.block_toolbox_category_occ_create_wire,
            resources.block_toolbox_category_occ_create_face,
            resources.block_toolbox_category_occ_create_solid,
            resources.block_toolbox_category_occ_apply,
            resources.block_toolbox_category_occ_apply_boolean,
            resources.block_toolbox_category_occ_apply_transform,
