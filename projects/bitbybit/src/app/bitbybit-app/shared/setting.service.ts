...
export class SettingsService {
    ...
    private setToolboxTexts(resources: ResourcesInterface) {
        ...
        const toolboxCategoryFlatList = [
            ...
            resources.block_toolbox_category_core_node,
            resources.block_toolbox_category_draw,
            resources.block_toolbox_category_create,
            resources.block_toolbox_category_apply,
            resources.block_toolbox_category_apply_transform,
            ...
            resources.block_toolbox_category_create,
            resources.block_toolbox_category_apply,
            resources.block_toolbox_category_geom_verbnurbs,
            resources.block_toolbox_category_geom_curve,
            resources.block_toolbox_category_draw,
            resources.block_toolbox_category_apply_transform,
            resources.block_toolbox_category_geom_base,
            resources.block_toolbox_category_create,
            resources.block_toolbox_category_apply,
            ...
            resources.block_toolbox_category_occ_draw,
            resources.block_toolbox_category_occ_io,
            resources.block_toolbox_category_occ_shapes,
            resources.block_toolbox_category_occ_edge,
            resources.block_toolbox_category_occ_wire,
            resources.block_toolbox_category_occ_face,
            resources.block_toolbox_category_occ_create_solid,
            resources.block_toolbox_category_occ_apply_compound,
            resources.block_toolbox_category_occ_operation,
            resources.block_toolbox_category_occ_boolean,
            resources.block_toolbox_category_occ_transform,
            ...
            resources.block_toolbox_category_expansions,
