...
export function createRevolveBlock(): void {
    ...
    const blockSelector = 'occ_revolve';
    ...
    Blocks[blockSelector] = {
        init(): void {
            this.appendValueInput('OccShape')
                ...
                .appendField(resources.block_occ_revolve_input_shape);
            this.appendValueInput('Angle')
                .setCheck('Number')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_occ_revolve_input_angle.toLowerCase());
            this.appendValueInput('Direction')
                .setCheck('Array')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_occ_revolve_input_direction.toLowerCase());
            this.appendValueInput('Copy')
                .setCheck('Boolean')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_occ_revolve_input_copy.toLowerCase());
    ...
    JavaScript[blockSelector] = (block: Block) => {
        ...
        BitByBitBlockHandlerService.validate(block, block.workspace, makeRequiredValidationModelForInputs(resources, inputs, [
            resources.block_occ_revolve_input_shape,
            resources.block_occ_revolve_input_angle,
            resources.block_occ_revolve_input_direction,
            resources.block_occ_revolve_input_copy,
        ...
        const code = createStandardContextIIFE(block, blockSelector, inputs, true,
            `bitbybit.occ.revolve(inputs)`, true
        );
...
function makeRuntimeValidationModel(
    ...
    return [{
        entity: keys[0],
        validations: [
            getRequired(resources, resources.block_occ_revolve_input_shape),
        ]
    }, {
        entity: keys[1],
        validations: [
            getRequired(resources, resources.block_occ_revolve_input_angle),
        ]
    }, {
        entity: keys[2],
        validations: [
            getRequired(resources, resources.block_occ_revolve_input_direction),
        ]
    }, {
        entity: keys[3],
        validations: [
            getRequired(resources, resources.block_occ_revolve_input_copy),
        ]
    }];
}
