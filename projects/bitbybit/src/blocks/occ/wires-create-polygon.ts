...
export function createWiresCreatePolygonBlock(): void {
    ...
    const blockSelector = 'occ_wires_create_polygon';
    ...
    Blocks[blockSelector] = {
        init(): void {
            ...
            this.setHelpUrl(environment.docsUrl + occConstants.occHelpUrl + '#' + 'createpolygonwire');
        }
    };
    ...
    JavaScript[blockSelector] = (block: Block) => {
        ...
        const code = createStandardContextIIFE(block, blockSelector, inputs, true,
            `bitbybit.occ.createPolygonWire(inputs)`, true
        );
