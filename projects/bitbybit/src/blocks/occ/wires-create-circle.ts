...
export function createWiresCreateCircleBlock(): void {
    ...
    const blockSelector = 'occ_wires_create_circle';
    ...
    Blocks[blockSelector] = {
        init(): void {
            this.appendValueInput('Radius')
                ...
                .appendField(resources.block_occ_wires_create_circle_input_radius);
            this.appendValueInput('Center')
                .setCheck('Array')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_occ_wires_create_circle_input_center.toLowerCase());
            this.setOutput(true, 'OccShape');
            this.setColour('#fff');
            this.setTooltip(resources.block_occ_wires_create_circle_description);
    ...
    JavaScript[blockSelector] = (block: Block) => {
        ...
        BitByBitBlockHandlerService.validate(block, block.workspace, makeRequiredValidationModelForInputs(resources, inputs, [
            resources.block_occ_wires_create_circle_input_radius,
            resources.block_occ_wires_create_circle_input_center,
        ]));
        ...
        const code = createStandardContextIIFE(block, blockSelector, inputs, true,
            `bitbybit.occ.createCircleWire(inputs)`, true
        );
...
function makeRuntimeValidationModel(
    ...
    return [{
        entity: keys[0],
        validations: [
            getRequired(resources, resources.block_occ_wires_create_circle_input_radius),
        ]
    }, {
        entity: keys[1],
        validations: [
            getRequired(resources, resources.block_occ_wires_create_circle_input_center),
        ]
    }
    ];
}
