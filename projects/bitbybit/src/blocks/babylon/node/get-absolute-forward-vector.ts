...
export function createNodeGetAbsoluteForwardVectorBlock(): void {

    const resources = ResourcesService.getResources();
    const blockSelector = 'base_geometry_node_get_absolute_forward_vector';
    ...
    Blocks[blockSelector] = {
        init(): void {
            ...
            this.setHelpUrl(environment.docsUrl + nodeConstants.helpUrl + '#' + 'getabsoluteforwardvector');
        }
    };
