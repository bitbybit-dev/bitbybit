...
import { getOfLength, getRequired, makeRequiredValidationModelForInputs, HS, ValidationEntityInterface } from '../../../validations';
...
export function createPointDistanceBlock() {
    ...
    Blocks[blockSelector] = {
        init() {
            ...
            this.setHelpUrl(environment.docsUrl + pointConstants.helpUrl + '#' + 'distance');
        }
    };
    ...
    JavaScript[blockSelector] = (block: Block) => {
        ...
        const code = createStandardContextIIFE(block, blockSelector, inputs, true,
            `return bitbybit.point.distance(inputs);`
        );
