...
export function createDateSetMonthBlock() {

    const resources = ResourcesService.getResources();
    const blockSelector = 'base_date_set_month';
    ...
    Blocks[blockSelector] = {
        init() {
            this.appendValueInput('Date')
                ...
                .appendField(resources.block_base_date_set_month_input_date);
            this.appendValueInput('Month')
                .setCheck('Number')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_base_date_set_month_input_month.toLowerCase());
            this.setOutput(true, 'Number');
            this.setColour('#fff');
            this.setTooltip(resources.block_base_date_set_month_description);
        }
    };
