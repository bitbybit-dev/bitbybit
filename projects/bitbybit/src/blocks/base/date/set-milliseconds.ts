...
export function createDateSetMillisecondsBlock() {

    const resources = ResourcesService.getResources();
    const blockSelector = 'base_date_set_milliseconds';
    ...
    Blocks[blockSelector] = {
        init() {
            this.appendValueInput('Date')
                ...
                .appendField(resources.block_base_date_set_milliseconds_input_date);
            this.appendValueInput('Milliseconds')
                .setCheck('Number')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_base_date_set_milliseconds_input_milliseconds.toLowerCase());
            this.setOutput(true, 'Number');
            this.setColour('#fff');
            this.setTooltip(resources.block_base_date_set_milliseconds_description);
        }
    };
