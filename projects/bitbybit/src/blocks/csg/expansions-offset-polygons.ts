...
export function createExpansionsOffsetPolygonsBlock(): void {

    const resources = ResourcesService.getResources();
    const blockSelector = 'csg_expansions_offset_polygons';
    ...
    Blocks[blockSelector] = {
        init(): void {
            this.appendValueInput('Polygons')
                ...
                .appendField(resources.block_jscad_expansions_offset_polygons_input_polygons);
            this.appendValueInput('Delta')
                .setCheck('Number')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_jscad_expansions_offset_polygons_input_delta.toLowerCase());
            this.appendValueInput('Segments')
                .setCheck('Number')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_jscad_expansions_offset_polygons_input_segments.toLowerCase());
            this.appendValueInput('Corners')
                .setCheck('String')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_jscad_expansions_offset_polygons_input_corners.toLowerCase());
            this.setOutput(true, 'Array');
            this.setColour('#fff');
            this.setTooltip(resources.block_jscad_expansions_offset_polygons_description);
