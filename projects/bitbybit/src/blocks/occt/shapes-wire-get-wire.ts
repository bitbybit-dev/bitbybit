...
export function createWiresGetWireBlock(): void {
    ...
    const blockSelector = 'occt_shapes_wire_get_wire';
    ...
    Blocks[blockSelector] = {
        init(): void {
            this.appendValueInput('OccShape')
                ...
                .appendField(resources.block_occt_shapes_wire_get_wire_input_shape);
            this.appendValueInput('Index')
                .setCheck('Number')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_occt_shapes_wire_get_wire_input_index.toLowerCase());
    ...
    JavaScript[blockSelector] = (block: Block) => {
        ...
        HS.validate(block, block.workspace, makeRequiredValidationModelForInputs(resources, inputs, [
            resources.block_occt_shapes_wire_get_wire_input_shape,
            resources.block_occt_shapes_wire_get_wire_input_index,
        ]));
        ...
        const code = createStandardContextIIFE(block, blockSelector, inputs, true,
            `bitbybit.occt.shapes.wire.getWire(inputs)`, true
        );
...
function makeRuntimeValidationModel(
    ...
    return [{
        entity: keys[0],
        validations: [
            getRequired(resources, resources.block_occt_shapes_wire_get_wire_input_shape),
        ]
    }, {
        entity: keys[1],
        validations: [
            getRequired(resources, resources.block_occt_shapes_wire_get_wire_input_index),
        ]
    }
    ];
}
