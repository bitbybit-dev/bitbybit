...
export function createCoreVectorSubBlock() {
    ...
    const blockSelector = 'verb_core_vector_sub';
    ...
    Blocks[blockSelector] = {
        init() {
            this.appendValueInput('First')
                ...
                .appendField(resources.block_verb_core_vector_sub_input_first);
            this.appendValueInput('Second')
                .setCheck('Array')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_verb_core_vector_sub_input_second.toLowerCase());
            this.setOutput(true, 'Array');
            this.setColour('#fff');
            this.setTooltip(resources.block_verb_core_vector_sub_description);
            this.setHelpUrl(environment.docsUrl + vectorConstants.helpUrl + '#' + 'sub');
        }
    };
