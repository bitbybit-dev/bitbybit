...
export function createCoreVectorCrossBlock() {
    ...
    const blockSelector = 'verb_core_vector_cross';
    ...
    Blocks[blockSelector] = {
        init() {
            this.appendValueInput('First')
                ...
                .appendField(resources.block_verb_core_vector_cross_input_first);
            this.appendValueInput('Second')
                .setCheck('Array')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_verb_core_vector_cross_input_second.toLowerCase());
            this.setOutput(true, 'Number');
            this.setColour('#fff');
            this.setTooltip(resources.block_verb_core_vector_cross_description);
            this.setHelpUrl(environment.docsUrl + vectorConstants.helpUrl + '#' + 'cross');
        }
    };
