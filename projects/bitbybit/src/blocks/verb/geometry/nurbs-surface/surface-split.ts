...
export function createSurfaceSplitBlock(): void {

    const resources = ResourcesService.getResources();
    const blockSelector = 'verb_geometry_nurbs_surface_split';
    ...
    Blocks[blockSelector] = {
        init(): void {
            this.appendValueInput('Surface')
                ...
                .appendField(resources.block_verb_geometry_nurbs_surface_split_input_surface);
            this.appendValueInput('Parameter')
                .setCheck('Number')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_verb_geometry_nurbs_surface_split_input_parameter.toLowerCase());
            this.appendValueInput('UseV')
                .setCheck('Boolean')
                .setAlign(ALIGN_RIGHT)
                .appendField(resources.block_verb_geometry_nurbs_surface_split_input_use_v.toLowerCase());
            this.setOutput(true, 'Array');
            this.setColour('#fff');
            this.setTooltip(resources.block_verb_geometry_nurbs_surface_split_description);
            this.setHelpUrl(environment.docsUrl + surfaceConstants.helpUrl + '#' + 'split');
        }
    };
