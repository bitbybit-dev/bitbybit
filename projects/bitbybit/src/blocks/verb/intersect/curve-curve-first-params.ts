...
export function createIntersectCurveCurveFirstParamsBlock(): void {
    ...
    Blocks[blockSelector] = {
        init(): void {
            ...
            this.setHelpUrl(environment.docsUrl + intersectConstants.helpUrl + '#' + 'curvecurvefirstparams');
        }
    };
    ...
    JavaScript[blockSelector] = (block: Block) => {
        ...
        const code = createStandardContextIIFE(block, blockSelector, inputs, true,
            `return bitbybit.verb.intersect.curveCurveFirstParams(inputs);`
        );
