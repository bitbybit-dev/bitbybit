...
export function createIntersectCurveSurfaceSurfaceParamsBlock(): void {
    ...
    Blocks[blockSelector] = {
        init(): void {
            ...
            this.setHelpUrl(environment.docsUrl + intersectConstants.helpUrl + '#' + 'curvesurfacesurfaceparams');
        }
    };
    ...
    JavaScript[blockSelector] = (block: Block) => {
        ...
        const code = createStandardContextIIFE(block, blockSelector, inputs, true,
            `return bitbybit.verb.intersect.curveSurfaceSurfaceParams(inputs);`
        );
